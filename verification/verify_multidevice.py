    ...
    try:
        with sync_playwright() as p:
            ...
            for vp in viewports:
                ...
                page.screenshot(path=f"/home/jules/verification/screenshots/hub_{vp['name']}.png")

                # Test Vocab Topic Page with TTS and gender badges
                page.goto("http://localhost:8080/geriou-brezhoneg/topics/an-tiegezh.html")
                page.wait_for_timeout(500)
                page.screenshot(path=f"/home/jules/verification/screenshots/vocab_{vp['name']}.png")
