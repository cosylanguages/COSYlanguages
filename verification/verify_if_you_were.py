...
def run_cuj(page):
    ...
    page.goto("http://localhost:8080/events/if-you-were.html")
    page.wait_for_timeout(1000)

    # Take screenshot of parent page
    print("Capturing parent page screenshot...")
    page.screenshot(path="/home/jules/verification/screenshots/parent_page.png")
    ...
    page.screenshot(path="/home/jules/verification/screenshots/session_page.png")
    page.wait_for_timeout(1000)
