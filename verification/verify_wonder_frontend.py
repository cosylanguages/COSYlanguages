...
def run_cuj(page):
    ...
    page.screenshot(path="/home/jules/verification/screenshots/wonder_hub_new_card.png")
    ...
    page.wait_for_timeout(1000)
    page.screenshot(path="/home/jules/verification/screenshots/wonder_session_big.png")

    # 3. Mini mode with shared=true
    page.goto(f"{session_url}?mode=mini&shared=true")
    page.wait_for_timeout(1000)
    page.screenshot(path="/home/jules/verification/screenshots/wonder_session_mini.png")
