// COSYlanguages Breton Grammar Manual — shared interactivity
(function(){
  "use strict";
  ...
  function initChecklists(){
    document.querySelectorAll('.checklist[data-key]').forEach(function(box){
      var key = 'cosy-check-br-yezhadur-' + box.getAttribute('data-key');
      var stored = {};
      ...
      function updateProgress(){
        ...
        if(prog) prog.textContent = done + ' / ' + items.length + ' poent yezhadur c\'hoariet';
      }
