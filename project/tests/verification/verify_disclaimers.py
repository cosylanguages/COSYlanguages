...
def run_cuj(page):
    ...
    page.locator(".lyrics-container").screenshot(path="project/tests/verification/screenshots/disclaimer_verification.png")
    page.wait_for_timeout(1000)

if __name__ == "__main__":
    with sync_playwright() as p:
        browser = p.chromium.launch(headless=True)
        os.makedirs("project/tests/verification/videos", exist_ok=True)
