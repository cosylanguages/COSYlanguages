...
def run_cuj(page):
    # 1. Navigate to Karaoke Club hub
    page.goto("http://localhost:8080/apps/premium-events/nights/karaoke/karaoke-club.html")
    page.wait_for_timeout(1000)

    page.screenshot(path="/home/jules/project/tests/verification/screenshots/karaoke_hub.png")
    page.wait_for_timeout(500)

    # 2. Click on Gossip Challenge
    page.get_by_role("link", name="Enter Challenge →").first.click()
    page.wait_for_timeout(1000)

    page.screenshot(path="/home/jules/project/tests/verification/screenshots/karaoke_challenge.png")
    page.wait_for_timeout(1000)
