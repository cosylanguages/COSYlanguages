...
def run_audit():
    os.makedirs("project/tests/verification/screenshots/ref_apps", exist_ok=True)
    results = []
    ...
    with sync_playwright() as p:
        ...
        for app in APPS:
            ...
            for vp in VIEWPORTS:
                ...
                screenshot_path = f"project/tests/verification/screenshots/ref_apps/{app_id}_{vp['name']}.png"
