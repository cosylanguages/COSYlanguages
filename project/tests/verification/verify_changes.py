...
def run_verification():
    ...
    with sync_playwright() as p:
        ...
        page_1280.screenshot(path="/home/jules/project/tests/verification/screenshots/index_1280.png")
        ...
        page_1280.screenshot(path="/home/jules/project/tests/verification/screenshots/index_calc_1280.png")
        ...
        page_1280.wait_for_timeout(1000)
        page_1280.screenshot(path="/home/jules/project/tests/verification/screenshots/karaoke_1280.png")
        ...
        page_375.screenshot(path="/home/jules/project/tests/verification/screenshots/index_375.png")

        # 2. Calculator on Homepage at 375px
        page_375.locator("#calculator").scroll_into_view_if_needed()
        page_375.wait_for_timeout(1000)
        page_375.screenshot(path="/home/jules/project/tests/verification/screenshots/index_calc_375.png")
        ...
        page_375.wait_for_timeout(1000)
        page_375.screenshot(path="/home/jules/project/tests/verification/screenshots/karaoke_375.png")
