...
def run_cuj(page):
    ...
    page.screenshot(path="project/tests/verification/screenshots/celebrate_cards_split_all.png")
    page.wait_for_timeout(500)
    ...
    page.screenshot(path="project/tests/verification/screenshots/celebrate_session_page.png")
    page.wait_for_timeout(500)
    ...
    if level_btn.is_visible():
        ...
        page.screenshot(path="project/tests/verification/screenshots/celebrate_session_switched_a2.png")
