...
(async () => {
  ...
  fs.mkdirSync('/home/jules/project/tests/verification/videos', { recursive: true });
  fs.mkdirSync('/home/jules/project/tests/verification/screenshots', { recursive: true });

  const browser = await chromium.launch({ headless: true });
  const context = await browser.newContext({
    recordVideo: {
      dir: '/home/jules/project/tests/verification/videos',
  ...
  await page.screenshot({ path: '/home/jules/project/tests/verification/screenshots/verification.png' });
  await page.waitForTimeout(1000);
