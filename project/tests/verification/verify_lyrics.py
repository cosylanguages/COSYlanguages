...
def run_cuj(page):
    ...
    page.screenshot(path="/home/jules/project/tests/verification/screenshots/lyrics_initial.png")
    ...
    page.wait_for_timeout(1000)
    page.screenshot(path="/home/jules/project/tests/verification/screenshots/lyrics_wrong.png")

    # Now let's type the correct answer (even with different case / accent normalized, like 'MACHINES')
    first_input.fill("MACHINES")
    page.wait_for_timeout(1000)
    page.screenshot(path="/home/jules/project/tests/verification/screenshots/lyrics_correct.png")
