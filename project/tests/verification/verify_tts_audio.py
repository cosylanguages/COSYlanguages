...
async def verify():
    async with async_playwright() as p:
        ...
        await page.screenshot(path="/home/jules/project/tests/verification/screenshots/tts_audio_question.png")
        print("Saved screenshot /home/jules/project/tests/verification/screenshots/tts_audio_question.png")
