...
{render_footer()}
 ...
 <p>Ready for the next step? Advance to English Grammar Manual Level A2 covering past continuous, present perfect, conditionals, passive, and modals.</p>
 <span class="topics-count">Open Grammar Manual A2 &rarr;</span>
</a>""")
