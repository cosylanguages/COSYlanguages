...
LANGUAGES = {
    ...
    "fr_a2": {
        ...
        "portal_label": "← Hub COSYfrançais",
        "manifesto_title": "★ COMMENT FONCTIONNE LE SYSTÈME",
        "manifesto_text": "Le niveau A2 consolide vos bases. Utilisez le <strong>Manuel de Grammaire A2</strong> pour les récits au passé et hypothèses, et le <strong>Manuel de Vocabulaire A2</strong> pour exprimer vos souvenirs et projets. Consulter le <a href='francaise-b1.html'>Niveau B1 Hub</a> ou retourner au <a href='francaise-a0-a1.html'>Niveau A0–A1</a>.",
        "g_badge": "LIVRE 1 · MANUEL DE GRAMMAIRE",
    ...
    "fr_b1": {
        "filename": "francaise-b1.html",
        "lang_code": "fr",
        "name_en": "French (Level B1)",
        "native_name": "Français B1",
        "flag": "🇫🇷",
        "title": "COSYlanguages Français Live B1 · Manuels d'Apprentissage",
        "meta_desc": "Système d'apprentissage complet du français (Niveau B1) : Livre 1 Grammaire Française et Livre 2 Vocabulaire Français.",
        "kicker": "Système d'Apprentissage Complet · Niveau B1",
        "h1": "Manuels d'Apprentissage du Français (Niveau B1)",
        "lead": "Nuancer sa pensée et exprimer des opinions : subjonctif présent, cause & conséquence, opinion, doute et connecteurs d'argumentation.",
        "portal_url": "../languages/fr.html",
        "portal_label": "← Hub COSYfrançais",
        "manifesto_title": "★ COMMENT FONCTIONNE LE SYSTÈME",
        "manifesto_text": "Le niveau B1 développe votre autonomie et la nuance. Utilisez le <strong>Manuel de Grammaire B1</strong> pour le subjonctif et l'argumentation, et le <strong>Manuel de Vocabulaire B1</strong> pour exprimer vos convictions et débattre. Consulter le <a href='francaise-a2.html'>Niveau A2 Hub</a>.",
        "g_badge": "LIVRE 1 · MANUEL DE GRAMMAIRE",
        "g_title": "Grammaire Française (B1)",
        "g_desc": "Subjonctif présent (nécessité, volonté, opinion, doute), cause et conséquence, et connecteurs logiques de l'argumentation.",
        "g_btn": "Ouvrir la Grammaire B1 →",
        "g_url": "fr/grammar/b1/index.html",
        "v_badge": "LIVRE 2 · MANUEL DE VOCABULAIRE",
        "v_title": "Lexique Français (B1)",
        "v_desc": "Vocabulaire thématique B1 : nuance de pensée, expression de l'opinion, du doute, de la cause, du résultat et du débat d'idées.",
        "v_btn": "Ouvrir le Lexique B1 →",
        "v_url": "fr/vocabulary/b1/index.html",
    },
    "it": {
    ...
    "it_a2": {
        ...
        "portal_label": "← Hub COSYitaliano",
        "manifesto_title": "★ COME FUNZIONA IL SISTEMA",
        "manifesto_text": "Il livello A2 consolida le tue basi. Usa la <strong>Grammatica Italiana A2</strong> per i racconti al passato ed ipotesi, e il <strong>Lessico Italiano A2</strong> per esprimere ricordi e progetti futuri. Scopri il <a href='italiano-b1.html'>Livello B1 Hub</a> o torna al <a href='italiano-a0-a1.html'>Livello A0–A1</a>.",
        "g_badge": "LIBRO 1 · MANUALE DI GRAMMATICA",
    ...
    "it_b1": {
        "filename": "italiano-b1.html",
        "lang_code": "it",
        "name_en": "Italian (Level B1)",
        "native_name": "Italiano B1",
        "flag": "🇮🇹",
        "title": "COSYlanguages Italiano Live B1 · Manuali d'Apprendimento",
        "meta_desc": "Sistema completo di apprendimento dell'italiano (Livello B1): Libro 1 Grammatica Italiana e Libro 2 Lessico Italiano.",
        "kicker": "Sistema Completo · Livello B1",
        "h1": "Manuali d'Apprendimento d'Italiano (Livello B1)",
        "lead": "Sfumare il pensiero ed esprimere opinioni: congiuntivo presente, causa ed effetto, opinione, dubbio e connettori argomentativi.",
        "portal_url": "../languages/it.html",
        "portal_label": "← Hub COSYitaliano",
        "manifesto_title": "★ COME FUNZIONA IL SISTEMA",
        "manifesto_text": "Il livello B1 sviluppa l'autonomia espressiva. Usa la <strong>Grammatica Italiana B1</strong> per il congiuntivo ed i connettori, e il <strong>Lessico Italiano B1</strong> per argomentare e sostenere dibattiti. Torna al <a href='italiano-a2.html'>Livello A2 Hub</a>.",
        "g_badge": "LIBRO 1 · MANUALE DI GRAMMATICA",
        "g_title": "Grammatica Italiana (B1)",
        "g_desc": "Congiuntivo presente (opinione, dubbio, desiderio), causa e conseguenza avanzata, e connettori discorsivi.",
        "g_btn": "Apri la Grammatica B1 →",
        "g_url": "it/grammar/b1/index.html",
        "v_badge": "LIBRO 2 · MANUALE DI LESSICO",
        "v_title": "Lessico Italiano (B1)",
        "v_desc": "Vocabolario tematico B1: espressione di opinioni, dubbi, desideri, causa-effetto e dibattito ed argomentazione.",
        "v_btn": "Apri il Lessico B1 →",
        "v_url": "it/vocabulary/b1/index.html",
    },
    "es": {
    ...
    "es_a2": {
        ...
        "portal_label": "← Hub COSYespañol",
        "manifesto_title": "★ CÓMO FUNCIONA EL SISTEMA",
        "manifesto_text": "El nivel A2 consolida tus bases. Usa la <strong>Gramática Española A2</strong> para relatos en pasado e hipótesis, y el <strong>Vocabulario Español A2</strong> para expresar recuerdos y proyectos futuros. Descubre el <a href='espanol-b1.html'>Nivel B1 Hub</a> o vuelve al <a href='espanol-a0-a1.html'>Nivel A0–A1</a>.",
        "g_badge": "LIBRO 1 · MANUAL DE GRAMÁTICA",
    ...
    "es_b1": {
        "filename": "espanol-b1.html",
        "lang_code": "es",
        "name_en": "Spanish (Level B1)",
        "native_name": "Español B1",
        "flag": "🇪🇸",
        "title": "COSYlanguages Español Live B1 · Manuales de Aprendizaje",
        "meta_desc": "Sistema completo de aprendizaje del español (Nivel B1): Libro 1 Gramática Española y Libro 2 Vocabulario Español.",
        "kicker": "Sistema de Aprendizaje Integral · Nivel B1",
        "h1": "Manuales de Aprendizaje de Español (Nivel B1)",
        "lead": "Matizar el pensamiento y expresar opiniones: presente de subjuntivo, causa y consecuencia, duda y conectores discursivos en el debate.",
        "portal_url": "../languages/es.html",
        "portal_label": "← Hub COSYespañol",
        "manifesto_title": "★ CÓMO FUNCIONA EL SISTEMA",
        "manifesto_text": "El nivel B1 potencia tu autonomía. Usa la <strong>Gramática Española B1</strong> para el subjuntivo y los conectores, y el <strong>Vocabulario Español B1</strong> para expresar convicciones y debatir. Volver al <a href='espanol-a2.html'>Nivel A2 Hub</a>.",
        "g_badge": "LIBRO 1 · MANUAL DE GRAMÁTICA",
        "g_title": "Gramática Española (B1)",
        "g_desc": "Presente de subjuntivo (opinión, duda, deseo), causa y consecuencia, y conectores discursivos para el debate.",
        "g_btn": "Abrir la Gramática B1 →",
        "g_url": "es/grammar/b1/index.html",
        "v_badge": "LIBRO 2 · MANUAL DE VOCABULARIO",
        "v_title": "Vocabulario Español (B1)",
        "v_desc": "Vocabulario temático B1: expresión de opiniones, dudas, expectativas, causa-efecto y términos de debate y refutación.",
        "v_btn": "Abrir el Vocabulario B1 →",
        "v_url": "es/vocabulary/b1/index.html",
    },
    "de": {
        "filename": "deutsch-a0-a1.html",
        "lang_code": "de",
        "name_en": "German (Level A0–A1)",
        "native_name": "Deutsch A0–A1",
        "flag": "🇩🇪",
        ...
        "h1": "Deutsch Lernhandbücher (Niveau A0–A1)",
        ...
        "manifesto_text": "Jedes Niveau bei COSYlanguages verbindet zwei Handbücher. Nutze die <strong>Deutsche Grammatik</strong> für Satzbau und Kasus und den <strong>Deutschen Wortschatz</strong> für neue Begriffe. Besuche auch unser <a href='deutsch-b1.html'>Niveau B1 Hub</a>.",
        "g_badge": "BUCH 1 · GRAMMATIKHANDBUCH",
        "g_title": "Deutsche Grammatik (A0–A1)",
        ...
        "v_title": "Deutscher Wortschatz (A0–A1)",
    ...
    "de_b1": {
        "filename": "deutsch-b1.html",
        "lang_code": "de",
        "name_en": "German (Level B1)",
        "native_name": "Deutsch B1",
        "flag": "🇩🇪",
        "title": "COSYlanguages Deutsch Live B1 · Lernhandbücher",
        "meta_desc": "Vollständiges Deutsch-Lernsystem (Niveau B1): Buch 1 Deutsche Grammatik und Buch 2 Deutscher Wortschatz.",
        "kicker": "Vollständiges Lernsystem · Niveau B1",
        "h1": "Deutsch Lernhandbücher (Niveau B1)",
        "lead": "Meinung nuancieren und argumentieren: Subjunktionen (weil, da, obwohl), Konjunktiv II für Höflichkeit, Kausalität und Satzverbindungen.",
        "portal_url": "../languages/de.html",
        "portal_label": "← COSYdeutsch Hub",
        "manifesto_title": "★ WIE DAS SYSTEM FUNKTIONIERT",
        "manifesto_text": "Niveau B1 stärkt Ihre selbstständige Sprachverwendung. Nutzen Sie die <strong>Deutsche Grammatik B1</strong> für komplexe Satzgefüge und den <strong>Deutschen Wortschatz B1</strong> für Argumentation und Debatten. Zurück zum <a href='deutsch-a0-a1.html'>Niveau A0–A1 Hub</a>.",
        "g_badge": "BUCH 1 · GRAMMATIKHANDBUCH",
        "g_title": "Deutsche Grammatik (B1)",
        "g_desc": "Subjunktionen mit Verb am Ende, Konjunktiv II für Höflichkeit und Wünsche, Kausalitätskonnektoren und Argumentationsstrukturen.",
        "g_btn": "Deutsche Grammatik B1 öffnen →",
        "g_url": "de/grammar/b1/index.html",
        "v_badge": "BUCH 2 · WORTSCHATZHANDBUCH",
        "v_title": "Deutscher Wortschatz (B1)",
        "v_desc": "Thematischer Wortschatz B1: Meinung, Zweifel, Hoffnungen, Ursache-Wirkung und Begriffe der Debatte und Widerlegung.",
        "v_btn": "Deutschen Wortschatz B1 öffnen →",
        "v_url": "de/vocabulary/b1/index.html",
    },
    "pt": {
    ...
    "pt_a2": {
        ...
        "portal_label": "← Hub COSYportuguês",
        "manifesto_title": "★ COMO FUNCIONA O SISTEMA",
        "manifesto_text": "O nível A2 consolida as suas bases. Utilize a <strong>Gramática Portuguesa A2</strong> para narrativas no passado e hipóteses, e o <strong>Vocabulário Português A2</strong> para expressar memórias e projetos futuros. Descubra o <a href='portugues-b1.html'>Nível B1 Hub</a> ou volte ao <a href='portugues-a0-a1.html'>Nível A0–A1</a>.",
        "g_badge": "LIVRO 1 · MANUAL DE GRAMÁTICA",
    ...
    "pt_b1": {
        "filename": "portugues-b1.html",
        "lang_code": "pt",
        "name_en": "Portuguese (Level B1)",
        "native_name": "Português B1",
        "flag": "🇵🇹",
        "title": "COSYlanguages Português Live B1 · Manuais de Aprendizagem",
        "meta_desc": "Sistema completo de aprendizagem de português (Nível B1): Livro 1 Gramática Portuguesa e Livro 2 Vocabulário Português.",
        "kicker": "Sistema de Aprendizagem Integrado · Nível B1",
        "h1": "Manuais de Aprendizagem de Português (Nível B1)",
        "lead": "Matizar o pensamento e expressar opiniões: presente do subjuntivo/conjuntivo, causa e consequência, dúvida e conectores de discurso no debate.",
        "portal_url": "../languages/pt.html",
        "portal_label": "← Hub COSYportuguês",
        "manifesto_title": "★ COMO FUNCIONA O SISTEMA",
        "manifesto_text": "O nível B1 desenvolve a sua autonomia. Utilize a <strong>Gramática Portuguesa B1</strong> para o subjuntivo e os conectores, e o <strong>Vocabulário Português B1</strong> para expressar convicções e debater. Voltar ao <a href='portugues-a2.html'>Nível A2 Hub</a>.",
        "g_badge": "LIVRO 1 · MANUAL DE GRAMÁTICA",
        "g_title": "Gramática Portuguesa (B1)",
        "g_desc": "Presente do subjuntivo (opinião, dúvida, desejo), causa e consequência, e conectores de discurso para o debate.",
        "g_btn": "Abrir a Gramática B1 →",
        "g_url": "pt/grammar/b1/index.html",
        "v_badge": "LIVRO 2 · MANUAL DE VOCABULÁRIO",
        "v_title": "Vocabulário Português (B1)",
        "v_desc": "Vocabulário temático B1: expressão de opiniões, dúvidas, expectativas, causa-efeito e termos de debate e refutação.",
        "v_btn": "Abrir o Vocabulário B1 →",
        "v_url": "pt/vocabulary/b1/index.html",
    },
    "ru": {
        "filename": "russkiy-a0-a1.html",
        "lang_code": "ru",
        "name_en": "Russian",
        "native_name": "Русский язык A0–A1",
        "flag": "🇷🇺",
        ...
        "manifesto_text": "Каждый уровень в COSYlanguages состоит из двух книг. Используйте <strong>Грамматику русского языка</strong> для изучения падежей и спряжений, а <strong>Лексику русского языка</strong> для расширения словарного запаса. Перейдите на <a href='russkiy-b1.html'>Уровень B1 Hub</a>.",
    ...
    "ru_b1": {
        "filename": "russkiy-b1.html",
        "lang_code": "ru",
        "name_en": "Russian (Level B1)",
        "native_name": "Русский язык B1",
        "flag": "🇷🇺",
        "title": "COSYlanguages Русский язык Live B1 · Учебные руководства",
        "meta_desc": "Полный обучающий комплекс русского языка (Уровень B1): Книга 1 Грамматика русского языка и Книга 2 Лексика русского языка.",
        "kicker": "Полная учебная система · Уровень B1",
        "h1": "Учебные руководства по русскому языку (Уровень B1)",
        "lead": "Аргументация и выражение мнения: сложноподчиненные предложения, союзы причины и уступки, вводные слова и логика дискуссии.",
        "portal_url": "../languages/ru.html",
        "portal_label": "← Hub COSYрусский",
        "manifesto_title": "★ КАК РАБОТАЕТ ОБУЧАЮЩАЯ СИСТЕМА",
        "manifesto_text": "Уровень B1 развивает навык независимой дискуссии. Используйте <strong>Грамматику русского языка B1</strong> для изучения сложных союзов и <strong>Лексику B1</strong> для выражения личного мнения и дебатов. Вернуться к <a href='russkiy-a0-a1.html'>Уровню A0–A1 Hub</a>.",
        "g_badge": "КНИГА 1 · ГРАММАТИЧЕСКОЕ РУКОВОДСТВО",
        "g_title": "Грамматика русского языка (B1)",
        "g_desc": "Сложноподчиненные предложения причины и уступки (потому что, так как, хотя), вводные слова и логические выводы.",
        "g_btn": "Открыть Грамматику B1 →",
        "g_url": "ru/grammar/b1/index.html",
        "v_badge": "КНИГА 2 · ЛЕКСИЧЕСКОЕ РУКОВОДСТВО",
        "v_title": "Лексика русского языка (B1)",
        "v_desc": "Тематический словарный запас B1: выражение мнения, сомнения, причинно-следственные связи, дебаты и опровержение.",
        "v_btn": "Открыть Лексику B1 →",
        "v_url": "ru/vocabulary/b1/index.html",
    },
    "br": {
    ...
    "el": {
        ...
        "lang_code": "el",
        "name_en": "Greek (Level A0–A1)",
        "native_name": "Ελληνικά A0–A1",
        "flag": "🇬🇷",
        ...
        "h1": "Εγχειρίδια Εκμάθησης Ελληνικών (A0–A1)",
        ...
        "manifesto_text": "Κάθε επίπεδο στο COSYlanguages βασίζεται σε δύο αλληλένδετα βιβλία. Μελετήστε τη <strong>Γραμματική Ελληνικών</strong> για τη δομή και το <strong>Ελληνικό Λεξιλόγιο</strong> για τον εμπλουτισμό των λέξεων σας. Επισκεφθείτε και το <a href='ellinika-b1.html'>Επίπεδο B1 Hub</a>.",
        "g_badge": "ΒΙΒΛΙΟ 1 · ΕΓΧΕΙΡΙΔΙΟ ΓΡΑΜΜΑΤΙΚΗΣ",
        "g_title": "Γραμματική Ελληνικών (A0–A1)",
        ...
        "v_title": "Ελληνικό Λεξιλόγιο (A0–A1)",
    ...
    "el_b1": {
        "filename": "ellinika-b1.html",
        "lang_code": "el",
        "name_en": "Greek (Level B1)",
        "native_name": "Ελληνικά B1",
        "flag": "🇬🇷",
        "title": "COSYlanguages Ελληνικά Live B1 · Εγχειρίδια Εκμάθησης",
        "meta_desc": "Ολοκληρωμένο σύστημα εκμάθησης ελληνικών (Επίπεδο B1): Βιβλίο 1 Γραμματική Ελληνικών και Βιβλίο 2 Ελληνικό Λεξιλόγιο.",
        "kicker": "Ολοκληρωμένο Σύστημα · Επίπεδο B1",
        "h1": "Εγχειρίδια Εκμάθησης Ελληνικών (Επίπεδο B1)",
        "lead": "Έκφραση γνώμης και επιχειρηματολογία: υποτακτική έγκλιση (πρέπει να, θέλω να, ελπίζω να), αιτιολογία, αποτέλεσμα και σύνδεσμοι διαλόγου.",
        "portal_url": "../languages/el.html",
        "portal_label": "← Hub COSYελληνικά",
        "manifesto_title": "★ ΠΩΣ ΛΕΙΤΟΥΡΓΕΙ ΤΟ ΣΥΣΤΗΜΑ",
        "manifesto_text": "Το επίπεδο B1 αναπτύσσει την αυτονομία σας στο διάλογο. Χρησιμοποιήστε τη <strong>Γραμματική Ελληνικών B1</strong> για την υποτακτική και τους συνδέσμους, και το <strong>Ελληνικό Λεξιλόγιο B1</strong> για την έκφραση απόψεων και επιχειρημάτων. Επιστροφή στο <a href='ellinika-a0-a1.html'>Επίπεδο A0–A1 Hub</a>.",
        "g_badge": "ΒΙΒΛΙΟ 1 · ΕΓΧΕΙΡΙΔΙΟ ΓΡΑΜΜΑΤΙΚΗΣ",
        "g_title": "Γραμματική Ελληνικών (B1)",
        "g_desc": "Υποτακτική έγκλιση (επιθυμία, ανάγκη, αμφιβολία), αιτιολογικοί και αποτελεσματικοί σύνδεσμοι, και επιχειρηματολογία.",
        "g_btn": "Άνοιγμα Γραμματικής B1 →",
        "g_url": "el/grammar/b1/index.html",
        "v_badge": "ΒΙΒΛΙΟ 2 · ΕΓΧΕΙΡΙΔΙΟ ΛΕΞΙΛΟΓΙΟΥ",
        "v_title": "Ελληνικό Λεξιλόγιο (B1)",
        "v_desc": "Θεματικό λεξιλόγιο B1: έκφραση γνώμης, αμφιβολίας, προσδοκιών, αιτίας, συνεπειών και όρων ανασκευής.",
        "v_btn": "Άνοιγμα Λεξιλογίου B1 →",
        "v_url": "el/vocabulary/b1/index.html",
    }
}
