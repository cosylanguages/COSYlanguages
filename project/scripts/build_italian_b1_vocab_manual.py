#!/usr/bin/env python3
"""
Generator script for COSYlanguages Italian Vocabulary Manual (Level B1) Interactive Web Edition.
Generates manuals/it/vocabulary/b1/index.html, module-N.html hubs, assets, and topic HTML pages in manuals/it/vocabulary/b1/topics/.
...
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "manuals/it/vocabulary/b1"))
...
STYLE_CSS = """/* COSYlanguages · Lessico Italiano Livello B1 */
...
APP_JS = """// COSYlanguages B1 Lessico Italiano · Interattività
(function(){
 "use strict";
 function initChecklists(){
   document.querySelectorAll('.checklist[data-key]').forEach(function(box){
     var key = 'cosy-it-b1-vocab-' + box.getAttribute('data-key');
     var stored = {};
...
MODULES = [
    {
        "id": "module-1",
        "file": "module-1.html",
        "title": "Modulo 1 · Opinioni, Dubbi e Speranze",
        "short_title": "Modulo 1",
        "subtitle": "Lessico dell'opinione personale, dell'incertezza e dei desideri.",
        "topics": ["esprimere-opinioni-e-dubbi", "il-lessico-dei-desideri-e-delle-aspettative"]
    },
    {
        "id": "module-2",
        "file": "module-2.html",
        "title": "Modulo 2 · Argomentazione e Dibattito",
        "short_title": "Modulo 2",
        "subtitle": "Lessico della causa, delle conseguenze e delle argomentazioni nel dibattito.",
        "topics": ["causa-effetto-ed-impatto", "i-termini-del-dibattito-e-della-confutazione"]
    }
]

TOPICS = {
    "esprimere-opinioni-e-dubbi": {
        "title": "Esprimere Opinioni e Dubbi",
        "subtitle": "Formule per esprimere punti di vista, incertezze e riserve",
        "module_title": "Modulo 1 · Opinioni, Dubbi e Speranze",
        "words": [
            {"word": "secondo me", "genre": "espr.", "ex": "Secondo me questo progetto ha un grande potenziale."},
            {"word": "un'opinione", "genre": "n.f.", "ex": "Rispettiamo l'opinione di tutti i partecipanti."},
            {"word": "un dubbio", "genre": "n.m.", "ex": "Ho qualche dubbio sulla fattibilità della proposta."},
            {"word": "ipotesi", "genre": "n.f.", "ex": "È un'ipotesi interessante che merita di essere approfondita."},
            {"word": "discutibile", "genre": "agg.", "ex": "Questa decisione resta discutibile sotto diversi aspetti."}
        ],
        "checklist": ["Conoscere le espressioni di punto di vista", "Saper esprimere incertezza con garbo"],
        "quiz": [
            {"q": "Quale parola indica un'incertezza sulla realtà di un fatto ?", "opts": ["un dubbio", "una certezza", "un accordo"], "correct": 0, "explain": "'Un dubbio' esprime mancanza di certezza."}
        ]
    },
    "il-lessico-dei-desideri-e-delle-aspettative": {
        "title": "Il Lessico dei Desideri e delle Aspettative",
        "subtitle": "Termini per esprimere speranze, obiettivi e preferenze",
        "module_title": "Modulo 1 · Opinioni, Dubbi e Speranze",
        "words": [
            {"word": "la speranza", "genre": "n.f.", "ex": "Abbiamo la speranza di raggiungere un accordo entro domani."},
            {"word": "un augurio", "genre": "n.m.", "ex": "Mando i miei migliori auguri per il nuovo lavoro."},
            {"word": "auspicare", "genre": "v.", "ex": "Auspichiamo che la situazione si risolva al più presto."},
            {"word": "un obiettivo", "genre": "n.m.", "ex": "Il nostro obiettivo principale è migliorare la qualità."},
            {"word": "preferire", "genre": "v.", "ex": "Preferirei che fissassimo la riunione di mattina."}
        ],
        "checklist": ["Esprimere desideri formali e informali", "Usare verbi di aspettativa"],
        "quiz": [
            {"q": "Quale verbo formale significa 'sperare vivamente' ?", "opts": ["auspicare", "negare", "rifiutare"], "correct": 0, "explain": "'Auspicare' significa desiderare o sperare che qualcosa si realizzi."}
        ]
    },
    "causa-effetto-ed-impatto": {
        "title": "Causa, Effetto ed Impatto",
        "subtitle": "Vocabolario delle ragioni, dei risultati e delle ripercussioni",
        "module_title": "Modulo 2 · Argomentazione e Dibattito",
        "words": [
            {"word": "la ragione", "genre": "n.f.", "ex": "Spiega la ragione della tua scelta."},
            {"word": "un impatto", "genre": "n.m.", "ex": "La nuova norma avrà un impatto significativo sulle aziende."},
            {"word": "un fattore", "genre": "n.m.", "ex": "L'esperienza è un fattore determinante per il successo."},
            {"word": "generare", "genre": "v.", "ex": "L'innovazione può generare nuove opportunità di lavoro."},
            {"word": "di conseguenza", "genre": "loc. avv.", "ex": "I costi sono aumentati, di conseguenza abbiamo adeguato i prezzi."}
        ],
        "checklist": ["Identificare le cause e gli effetti", "Spiegare l'impatto di un cambiamento"],
        "quiz": [
            {"q": "Quale parola indica la conseguenza o l'effetto di un'azione ?", "opts": ["un impatto", "un'origine", "un passato"], "correct": 0, "explain": "'Un impatto' rappresenta l'effetto o la ripercussione di un fatto."}
        ]
    },
    "i-termini-del-dibattito-e-della-confutazione": {
        "title": "I Termini del Dibattito e della Confutazione",
        "subtitle": "Vocabolario per sostenere, contestare e sfumare un punto di vista",
        "module_title": "Modulo 2 · Argomentazione e Dibattito",
        "words": [
            {"word": "sostenere", "genre": "v.", "ex": "Il relatore sostiene che la teoria sia corretta."},
            {"word": "confutare", "genre": "v.", "ex": "L'esperto ha confutato l'argomento dell'avversario con i dati."},
            {"word": "ammettere", "genre": "v.", "ex": "Bisogna ammettere che i risultati sono incoraggianti."},
            {"word": "contestare", "genre": "v.", "ex": "Molti cittadini contestano la nuova delibera."},
            {"word": "sfumare", "genre": "v.", "ex": "È importante sfumare il giudizio senza categorizzazioni fisso."}
        ],
        "checklist": ["Sostenere un'idea in una discussione", "Confutare un argomento con educazione"],
        "quiz": [
            {"q": "Quale verbo significa 'dimostrare falso un argomento' ?", "opts": ["confutare", "sostenere", "ammettere"], "correct": 0, "explain": "'Confutare' significa respingere o dimostrare infondata una tesi."}
        ]
    }
}
...
def render_topbar(is_topic=False):
    ...
    return f'''<header class="topbar"><div class="topbar-inner"><a class="brand" href="{rel_prefix}index.html"><span class="brand-mark">cl</span><span>COSYlanguages · Lessico B1</span></a><nav class="topbar-nav"><a href="{hub_link}">← Hub Italiano B1</a></nav></div></header>'''

def render_footer():
    return '''<footer class="site"><div class="container"><div>COSYlanguages · Lessico Italiano (B1) · Edizione Web</div><div><a href="https://cosylanguages.github.io/COSYlanguages/index.html">← Torna alla home COSYlanguages</a></div></div></footer>'''

def build_all():
    print("Building Italian B1 Vocabulary Manual...")
    ...
    for idx, (slug, top) in enumerate(TOPICS.items()):
        ...
        check_html = f'<div class="checklist" data-key="{slug}"><h3>🎯 Competenze lessicali</h3>{c_items}</div>'
        ...
        quiz_html = f'<div class="quiz-panel" data-quiz=\'{quiz_json}\'><div class="quiz-head"><h2>Test di Lessico</h2><span class="quiz-score">Score: 0 / {len(q_data)}</span></div>{"".join(q_items)}</div>'
...
<title>{top["title"]} · Lessico Italiano B1</title>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>{m["title"]} · Lessico B1</title>
<link rel="stylesheet" href="assets/style.css">
</head>
<body>
...
{render_footer()}
    ...
    index_cards = []
    for m in MODULES:
        index_cards.append(f'''<a class="mcard" href="{m["file"]}"><h2>{m["title"]}</h2><p>{m["subtitle"]}</p><span style="font-size:12px;font-weight:700;color:var(--teal-800);">{len(m["topics"])} temi →</span></a>''')
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Lessico Italiano Livello B1 · COSYlanguages</title>
<link rel="stylesheet" href="assets/style.css">
</head>
<body>
{render_topbar(is_topic=False)}
<main class="container">
  <div class="page-head">
    ...
    <h1>Lessico Italiano (B1)</h1>
    <p class="subtitle">Manuale interattivo monolingua di vocabolario italiano livello B1.</p>
    <hr class="rule">
  </div>
...
{render_footer()}
    ...
    print("Italian B1 Vocabulary Manual generated successfully!")
