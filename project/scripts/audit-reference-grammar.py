...
def main():
    ...
    audit_output_path = os.path.join(repo_root, "project", "docs", "audits", "reference-grammar-audit.json")
    missing_output_path = os.path.join(repo_root, "project", "docs", "audits", "missing-from-inventory.json")
