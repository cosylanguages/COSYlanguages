...
{render_footer()}
 ...
 <span class="topics-count">Explore Part &rarr;</span>
    ...
    grid_cards.append("""<a class="part-card" href="../c1/index.html" style="border: 2px solid var(--teal-500); background: var(--teal-050);">
 <div class="stripe" style="background: var(--teal-500);"></div>
 <span class="pnum">NEXT LEVEL</span>
 <h2>Continue to Level C1 &rarr;</h2>
 <p>Ready for the next step? Advance to English Vocabulary Manual Level C1 covering 14 encyclopedic domains from academic research to AI ethics.</p>
 <span class="topics-count">Open Vocabulary Manual C1 &rarr;</span>
</a>""")
