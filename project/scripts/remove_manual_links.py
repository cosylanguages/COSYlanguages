...
hub_data = {
    'en': {'code': 'en', 'native': 'English', 'practice_lang': 'EN', 'apps': [{'name': 'English Verbs & Prepositions', 'url': 'https://cosylanguages.github.io/COSYtools/en-verb-prep/index.html', 'desc': 'Interactive engine for dependent prepositions & phrasal verbs.'}]},
    'fr': {'code': 'fr', 'native': 'Français', 'practice_lang': 'FR', 'apps': [{'name': 'Régime Prépositionnel Français', 'url': 'https://cosylanguages.github.io/COSYtools/fr-regime/index.html', 'desc': 'Engine for French verb, noun & adjective prepositional regimes.'}, {'name': 'Le Conjugeur Français', 'url': 'https://cosylanguages.github.io/COSYtools/fr-conjugeur/index.html', 'desc': 'Complete verb conjugation & tense reference.'}, {'name': 'Genre des Noms Français', 'url': 'https://cosylanguages.github.io/COSYtools/fr-genre/index.html', 'desc': 'Interactive French noun gender & rule finder.'}]},
    'it': {'code': 'it', 'native': 'Italiano', 'practice_lang': 'IT', 'apps': [{'name': 'Reggenza Verbale Italiana', 'url': 'https://cosylanguages.github.io/COSYtools/it-reggenza/index.html', 'desc': 'Italian prepositional regime engine for verbs, nouns & adjectives.'}, {'name': 'Il Coniugatore Italiano', 'url': 'https://cosylanguages.github.io/COSYtools/it-coniugatore/index.html', 'desc': 'Verb conjugation database & tense reference.'}, {'name': 'Genere dei Nomi Italiani', 'url': 'https://cosylanguages.github.io/COSYtools/it-genere/index.html', 'desc': 'Italian noun gender classification & irregular patterns.'}]},
    'ru': {'code': 'ru', 'native': 'Русский', 'practice_lang': 'RU', 'apps': [{'name': 'Спряжение русских глаголов', 'url': 'https://cosylanguages.github.io/COSYtools/ru-spryazhenie/index.html', 'desc': 'Russian verb conjugation & aspect pairs.'}, {'name': 'Род и падежи существительных', 'url': 'https://cosylanguages.github.io/COSYtools/ru-rod-padezhi/index.html', 'desc': 'Russian noun gender & 6-case declension engine.'}]},
    'el': {'code': 'el', 'native': 'Ελληνικά', 'practice_lang': 'EL', 'apps': [{'name': 'Σύνταξη Ρημάτων & Ουσιαστικών', 'url': 'https://cosylanguages.github.io/COSYtools/el-syntaxi/index.html', 'desc': 'Greek verb & noun syntax government engine.'}, {'name': 'Κλίση Ρημάτων', 'url': 'https://cosylanguages.github.io/COSYtools/el-klisi-rimaton/index.html', 'desc': 'Greek verb conjugation reference.'}, {'name': 'Γένος & Πτώσεις Ουσιαστικών', 'url': 'https://cosylanguages.github.io/COSYtools/el-genos-ptoseis/index.html', 'desc': 'Greek noun gender & case inflection reference.'}]},
...
subpage_data = {
    'en': {'apps': [{'title': 'English Verbs & Prepositions App', 'url': 'https://cosylanguages.github.io/COSYtools/en-verb-prep/index.html', 'desc': 'Interactive engine for dependent prepositions & phrasal verbs.'}], 'practice': '../../practice/index.html?lang=EN', 'games': '../../games/index.html?lang=EN', 'hub': 'index.html', 'lang': 'en'},
    'fr': {'apps': [{'title': 'Régime Prépositionnel Français', 'url': 'https://cosylanguages.github.io/COSYtools/fr-regime/index.html', 'desc': 'Moteur interactif pour les régimes des verbes, noms et adjectifs.'}, {'title': 'Le Conjugeur Français', 'url': 'https://cosylanguages.github.io/COSYtools/fr-conjugeur/index.html', 'desc': 'Référence complète des conjugaisons et temps.'}, {'title': 'Genre des Noms Français', 'url': 'https://cosylanguages.github.io/COSYtools/fr-genre/index.html', 'desc': 'Guide interactif du genre des noms et règles de terminaisons.'}], 'practice': '../../practice/index.html?lang=FR', 'games': '../../games/index.html?lang=FR', 'hub': 'index.html', 'lang': 'fr'},
    'it': {'apps': [{'title': 'Reggenza Verbale Italiana', 'url': 'https://cosylanguages.github.io/COSYtools/it-reggenza/index.html', 'desc': 'Engine interattivo per la reggenza di verbi, nomi e aggettivi.'}, {'title': 'Il Coniugatore Italiano', 'url': 'https://cosylanguages.github.io/COSYtools/it-coniugatore/index.html', 'desc': 'Database completo delle coniugazioni verbali.'}, {'title': 'Genere dei Nomi Italiani', 'url': 'https://cosylanguages.github.io/COSYtools/it-genere/index.html', 'desc': 'Guida interattiva al genere dei sostantivi.'}], 'practice': '../../practice/index.html?lang=IT', 'games': '../../games/index.html?lang=IT', 'hub': 'index.html', 'lang': 'it'},
    'ru': {'apps': [{'title': 'Спряжение русских глаголов', 'url': 'https://cosylanguages.github.io/COSYtools/ru-spryazhenie/index.html', 'desc': 'База спряжения и видовых пар глаголов.'}, {'title': 'Род и падежи существительных', 'url': 'https://cosylanguages.github.io/COSYtools/ru-rod-padezhi/index.html', 'desc': 'Интерактивная система падежей и рода.'}], 'practice': '../../practice/index.html?lang=RU', 'games': '../../games/index.html?lang=RU', 'hub': 'index.html', 'lang': 'ru'},
    'el': {'apps': [{'title': 'Σύνταξη Ρημάτων & Ουσιαστικών', 'url': 'https://cosylanguages.github.io/COSYtools/el-syntaxi/index.html', 'desc': 'Εφαρμογή σύνταξης και συντακτικής κυβέρνησης.'}, {'title': 'Κλίση Ρημάτων', 'url': 'https://cosylanguages.github.io/COSYtools/el-klisi-rimaton/index.html', 'desc': 'Πλήρης οδηγός κλίσης ρημάτων.'}, {'title': 'Γένος & Πτώσεις Ουσιαστικών', 'url': 'https://cosylanguages.github.io/COSYtools/el-genos-ptoseis/index.html', 'desc': 'Οδηγός γένους και πτώσεων ουσιαστικών.'}], 'practice': '../../practice/index.html?lang=EL', 'games': '../../games/index.html?lang=EL', 'hub': 'index.html', 'lang': 'el'}
}
