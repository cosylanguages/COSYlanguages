...
| **4. `COSYworld`** | **Self-Study Adventure Game**<br>Public access. | `https://cosylanguages.github.io/COSYworld/` | • Open-world 2D/3D visual learning environment<br>• Scene match interactive spatial rooms (`apartment`, `city`, `market`, `routine_calendar`) | **Visual Exploration App.** Accessible from `COSYlanguages/games/`, `COSYgames`, and `COSYmanuals`. |
