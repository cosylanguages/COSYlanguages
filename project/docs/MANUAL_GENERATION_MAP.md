...
| `manuals/pt/grammar/` | Portuguese | **(a) Generated** | `scripts/build_monolingual_grammar_manuals.py` | `python3 scripts/build_monolingual_grammar_manuals.py` |
| `manuals/ru/grammar/` | Russian | **(a) Generated** | `scripts/build_russian_grammar_manual.py` | `python3 scripts/build_russian_grammar_manual.py` |
...
| `manuals/br/grammar/` | Breton | **(b) Hand-authored HTML** | None | N/A (Hand-authored HTML) |
...
| `manuals/pt/vocabulary/` | Portuguese | **(a) Generated** | `scripts/build_monolingual_vocab_manuals.py` | `python3 scripts/build_monolingual_vocab_manuals.py` |
| `manuals/ru/vocabulary/` | Russian | **(a) Generated** | `scripts/build_russian_vocab_manual.py` | `python3 scripts/build_russian_vocab_manual.py` |
...
| `manuals/br/vocabulary/` | Breton | **(b) Hand-authored HTML** | None | N/A (Hand-authored HTML) |
...
- **`manuals/br/grammar/`** (Breton Grammar, 19 topics): Hand-authored static HTML with no generator script.
- **`manuals/br/vocabulary/`** (Breton Vocabulary, 19 topics): Hand-authored static HTML with no generator script.
