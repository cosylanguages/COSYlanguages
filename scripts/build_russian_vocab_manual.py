...
and 18 topic HTML pages in leksika-russkogo-yazyka/topics/.
"""
...
MODULES = [
    {
        ...
        "subtitle": "Приветствия, знакомство, семья, профессии и описание человека",
        "stripe": "#3562e0",
        "topics": [
            {
    ...
    },
    {
        "id": "razdel-3",
        "file": "razdel-3.html",
        "title": "Модуль 3 · Еда, напитки и здоровье",
        "subtitle": "Продукты питания, заказы в кафе и фразы о самочувствии",
        "stripe": "#c9740a",
        "topics": [
            {
                "slug": "eda-i-produkty",
    ...
    },
    {
        "id": "razdel-5",
        "file": "razdel-5.html",
        "title": "Модуль 5 · Учёба, досуг и хобби",
        "subtitle": "Учебные принадлежности, виды отдыха и числительные",
        "stripe": "#a3195b",
        "topics": [
            {
                "slug": "ucheba-i-klass",
...
print("Generated 18 vocabulary topic pages in leksika-russkogo-yazyka/topics/.")

# 2. Render Module Hub Pages (razdel-1.html .. razdel-6.html)
for mod in MODULES:
    topic_cards = []
    for top in mod["topics"]:
        num_w = len(top["words"])
...
<meta name="description" content="Интерактивное веб-издание справочника «Лексика русского языка» COSYlanguages A0-A1: 6 модулей, 18 тем, словарные карточки и упражнения.">
<link rel="stylesheet" href="assets/style.css">
</head>
<body>
...
<section class="hero" style="background:var(--teal-900); color:#eafaf5; padding:54px 0 44px;">
  <div class="container">
    ...
    <p class="lead" style="max-width:560px; color:#cdeee5; font-size:17px;">Полный интерактивный справочник по лексике для начинающих — 6 тематических модулей, 18 тем, словарные карточки с родом и сочетаемостью, интерактивные карточки для запоминания и самопроверка.</p>
  </div>
</section>
