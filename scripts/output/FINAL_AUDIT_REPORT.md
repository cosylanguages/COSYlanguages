...
The detailed audit report can be found in `scripts/output/game-data-audit.md`.
...
- **Level Coverage**: Coverage is strong for Starter (A1) and Elementary (A2) across most languages. Coverage for Intermediate (B1) and above is significantly lower for non-English languages.
...
## 3. Schema & Data Consistency Issues
