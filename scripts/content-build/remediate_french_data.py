...
VOCAB_FRENCH = {
    ...
    "La scène": ("espace surélevé où se produisent les artistes devant le public.", "La chanteuse s'est avancée sur la scène sous les projecteurs."),
    ...
    "Froid": ("de basse température ou insensibilité émotionnelle.", "Un froid glacial régnait dans cette maison abandonnée."),
    ...
    "loyer": ("somme payée périodiquement pour l'usage d'un logement.", "Elle travaille dur chaque mois pour pouvoir payer son loyer."),
    "automate": ("appareil imitant les mouvements d'un être vivant, sans âme.", "Elle se sent comme un automate à force de répéter les mêmes gestes."),
    ...
    "tomates": ("fruits rouges cultivés dans les potagers.", "Elle aimerait planter et récolter ses propres tomates dans son jardin."),
    "souterrain": ("qui est sous terre, comme le métro ou une cave.", "Le café se situe dans un centre commercial souterrain et sans lumière."),
    "pareils": ("qui sont semblables, identiques.", "Tous ses jours de travail se ressemblent et sont pareils."),
    "néon": ("tube lumineux à décharge électrique.", "La lumière artificielle du néon fatigue ses yeux fatigués."),
    ...
    "asphalte": ("matière noire servant de revêtement pour les routes.", "La chaleur monte de l'asphalte noir de la ville bondée."),
    ...
    "cinéma": ("art de projeter des films, ou mise en scène.", "Elle préfère fuir sa propre vie en s'enfermant au cinéma."),
    "battre": ("frapper de manière répétée, pulser.", "Elle peut sentir son cœur battre très fort dans sa poitrine."),
    "empires": ("grands domaines de pouvoir ou de richesse.", "Les hommes passent leur vie à bâtir des empires éphémères."),
    "châteaux": ("grandes demeures seigneuriales, châteaux de cartes.", "Ses projets se sont effondrés comme des châteaux de cartes."),

    # Un garçon pas comme les autres
    "folle": ("qui a perdu la raison, ou passionné à l'excès.", "C'est une folle passion qui l'unit à ce garçon indisponible."),
    "faute": ("erreur commise, manquement à un devoir.", "Ce n'est la faute de personne s'il ne partage pas ses sentiments."),
    ...
    "disques": ("supports ronds servant à enregistrer de la musique.", "Ils passent des heures à éconter de vieux disques de rock ensemble."),
    "boutique": ("magasin de vente au détail.", "Elle travaille dans une petite boutique de disques du centre-ville."),
    "galaxie": ("immense ensemble d'étoiles et de matière céleste.", "Elle a l'impression de venir d'une tout autre galaxie que lui."),

    # Les uns contre les autres
    "dort": ("verbe dormir au présent, être endormi.", "Elle dort paisiblement malgré l'agitation de la grande ville."),
    "caresse": ("action de toucher doucement en signe d'affection.", "Une tendre caresse sur la joue suffit à la rassurer."),
