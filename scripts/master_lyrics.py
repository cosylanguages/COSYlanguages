# master_lyrics.py
# Contains full authentic lyrics and their corresponding word bank helpers for the Karaoke songs.

LYRICS_DATA = {
    "a-diagnosis": {
        "helpers": ['diagnosis', 'label', 'bloating', 'bipolar', 'naturopath'],
        "lyrics": """[Verse 1 - REBECCA]
...
My diagnosis!"""
    ...
    "after-everything-ive-done-for-you": {
        "helpers": ['done', 'face', 'sidekick', 'clown', 'bridesmaid'],
        "lyrics": """[PAULA]
...
Keep thinking about his angel eyes (Ah-ha-ha)
I keep thinking, ah-ha-ha, ha-ha-ha
Keep thinking, had to pay the price (Ah-ha-ha)
Keep thinking, ah-ha-ha, ha-ha-ha
Keep thinking about his angel eyes (Ah-ha-ha)
I keep thinking, ah-ha-ha, ha-ha-ha
Keep thinking, had to pay the price (Ah-ha-ha)
Keep thinking, ah-ha-ha, ha-ha-ha"""
    ...
    "antidepressants-are-so-not-a-big-deal": {
        "helpers": ['deal', 'day', 'better', 'dosage', 'lawyers'],
        "lyrics": """[RESHMA]
...
2018, j'saim pas c'qui t'fout mais je suis plus qu'un animal
...
[Couplet 2]
Les gens me dicen à demi-mot, "Pour une fille belle t'es pas si bête
...
Balance ton quoi, balance ton quoi
...
Un jour peut-être ça changera, balance ton quoi"""
    ...
    "bien-plus-fort": {
        ...
        "lyrics": """Bien plus fort que le vent
...
Baby, please, we're casualties of war"""
    ...
    "chi-sara-con-te": {
        ...
        "lyrics": """Come al nostro primo appuntamento un anno fa
...
Ooh!"""
    ...
    "diva": {
        ...
        "lyrics": """Sans scrupules, sans façons
Un whisky sans les glaçons
J'fαι l’amour comme les garçons
Et on me dira que je suis une Diva

[Refrain]
Ah bon ! J’ai le coeur en carton
J'suis qu’une contre-façon
J’ai beaucoup trop le melon pour plaire aux cons
J'me maquille au volant
Je cherche le prince charmant
Et des fois j'pète les plombs

J'suis à station Gambetta
J'attends ce train de vie de pacha
Une vie de chien pour une dame à chat
Et on me dira que je suis une Diva
...
Pardon
Ca veut mettre des bâtons
Dans les roues des pietons
Je préfère dire non et payer l'addition
Si j'étais un garçon
Que j'faisais le patron
Me dira-t-on que je suis une Diva ?
...
C'est qui le patron ? C'est moi !"""
    ...
    "dont-be-a-lawyer": {
        "helpers": ['lawyer', 'LSAT', 'Glendale', 'fees', 'legalese'],
        "lyrics": """[JIM]
...
Perché le ultime sai non pesano mai"""
    ...
    "eleven-oclock": {
        "helpers": ['theatrical', 'workbook', 'medley', 'slut', 'crock'],
        "lyrics": """[REBECCA]
It's eleven o’clock
Eleven o'clock
...
Ah!"""
    ...
    "fit-hot-guys-have-problems-too": {
        "helpers": ['problems', 'perfect', 'slow-motion', 'traumas', 'pants'],
        "lyrics": """[WHITE JOSH]
One!
...
Let us ugly cry!"""
    ...
    "group-hang": {
        "helpers": ['hang', 'nachos', 'mushrooms', 'restaurant', 'cheesecake'],
        "lyrics": """[REBECCA, spoken]
...
Y ahora la parte más temida de andar con el grupo. ¡El cheque!"""
    ...
    "i-hate-everything-but-you": {
        "helpers": ['everything', 'mandolin', 'superfood', 'Frisbee', 'Caddyshack'],
        "lyrics": """[GREG]
...
I'll always hate guys who name their cars"""
    ...
    "im-a-good-person": {
        "helpers": ['person', 'humble', 'blessed', 'douchebags', 'husband'],
        "lyrics": """[REBECCA]
...
Screw you!"""
    ...
    "im-afraid-of-americans": {
        "helpers": ['America', 'world', 'afraid', 'Coke', 'joke'],
        "lyrics": """[Verse 1]
Jonny's in America
...
Jonny's an American"""
    ...
    "im-the-villain-in-my-own-story": {
        "helpers": ['villain', 'witch', 'UNICEF', 'composer', 'Satan'],
        "lyrics": """I try to be good to others
...
Is being the villain my destiny?"""
    ...
    "immobile": {
        ...
        "lyrics": """[Couplet 1]
J'm'approche du vide qui me guette
Je plonge, j'mets en premier la tête
...
Je t'aime comme je t'aime
Quel que soit l'endroit où la via t'emmène
...
Je sais tes peurs, j'essuie tes larmes"""
    ...
    "jim-beam": {
        ...
        "lyrics": """[Куплет 1: Земфира]
Грустная танцплощадка
На которой никто не танцует
Эта музыка не качает — и пусть
Танцы, как в лихорадке
Ты, как обычно, в чёрном
Ну а я излучаю тревогу и грусть
...
Полетели по небу нервы
Я заброшена и немного больна
Группа «Агата Кристи»
Год — девяносто первый
Мы рискуем и допиваем до дна

[Припев: Земфира & Рената Литвинова]
По высоким, по стаканам — Jim Beam
В губы целоваться неприятно — герпес достал
А под звёздами на крыше тепло вполне
Может, сходим погуляем — шагнём в кино?
...
По высоким, по стаканам — Jim Beam"""
    ...
    "kapoies-nychtes": {
        ...
        "lyrics": """Κάποιες νύχτες το φεγγάρι μας τρελαίνει και γελά
...
Oh oh oh oh, oh ! la nuit ne finit plus"""
    ...
    "la-tour-eiffel-est-pour-moi": {
        ...
        "lyrics": """#VERSE
De ma fenêtre je la voyais quand j'habitais à Nantes
Depuis Paris elle m'envoyait toutes ses étoiles filantes
À dix-huit ans, libre enfin, j'ai pris à huit heures trente
Ma jeunesse et le premier train pour voir la flamboyante
...
#VERSE
À Montparnasse j'ai atterri dans une chambre de bonne
On est quatre dans le même lit, mais notre vελux donne
Sur le ciel, et quand vient la nuit, si je lève la tête
Elle caresse mes insomnies de ses faussets de paillettes
...
#VERSE
Je ne mange qu'un jour sur deux, ça me fait de l'espace
Pour accueillir un bienheureux dans mon manteau trois places
Bien sûr que ce n'est pas sérieux, ces amours de passage
Elle me réchauffe une heure ou deux dans le froid des nuages
...
#VERSE
Ma pauvre petite maman, n'aie pas peur de ta fille
Je vis peut-être sans diamants mais j'ai les yeux qui brillent
Je possède en la regardant, ses feux qui s'éparpillent
Car c'est pour moi évidemment et moi seule qu'elle scintille
...
Chiss้า σε un fiore c'è la sotto la neve per te"""
    },
    "laziza": {
...
Je te veux si tu veux de moi"""
    ...
    "le-soleil-noir": {
        ...
        "lyrics": """Pour ne plus, jamais plus, vous parler de la pluie
...
Que la via était belle et folle mon histoire
Mais la terre s'est ouverte
Là-bas, quelque part
Mais la terre s'est ouverte
Et le soleil is noir
Des hommes sont murés
Tout là-bas, какое-то место, где-то там
Les hommes sont murés
Et c'est le désespoir
J'ai conjuré le sort, j'ai recherché l'oubli
J'ai refusé la mort, j'ai rejectionné l'ennui
Et j'ai serré les poings для упорядочения
Que la via était belle, fascinant le hasard
...
Et j'ai le désespoir..."""
    ...
    "leffet-de-masse": {
        "helpers": ['classe', 'histoire', 'masse', 'isole', 'idiot'],
        "lyrics": """[Couplet 1]
Il était dans ma classe, il vivait dans ta rue
C'était celui d'en face, oui, tul'asdéjà vu
Il partageaitton car dans les matins méchants
Turiais de lui car il était différent
...
[Rebecca, Valencia & Heather:]
Your sons are gonna be rapists!"""
    },
    "lifeboat": {
        "helpers": ['boat', 'ocean', 'lifeboat', 'sink', 'captain'],
        "lyrics": """[HEATHER MCNAMARA]
...
Eri un po' di più
Mi piaceva come amavi tu (Uh-uh)
...
Ma, d'amore, tu non muori mai, proprio mai
...
Don't wanna hurt no more"""
    ...
    "na-i-agapi-na": {
        ...
        "lyrics": """Να η αγάπη να, στ’ όνειρό μου ήρθε ξανά
...
σε ζητώ και δεν είσαι εδώ"""
    ...
    "nos-ames-sont": {
        ...
        "lyrics": """Ce que nos âmes sont enfants sages
...
Ce que nos âmes s'enterren au fond de nous prisonnières
Prisonnières
...
Me gusta el mundo"""
    ...
    "o-gatos": {
        ...
        "lyrics": """Ψάχνοντας σε παλιά χαρτιά
...
T'as pris le temps d'venir mais pas de rester
...
Pourquoi j'me mens à moi-même en croyant cque tu m'racontes ?
...
C'est oui ou bien c'est non"""
    ...
    "ouvrir-les-yeux": {
        "helpers": ['cœur', 'désespoir', 'mémoire', 'prisonnière', 'monde'],
        "lyrics": """[Couplet 1]
Et me voilà
Seule sans toi
...
Que je suis prisonnière du tmps qui passe ?
Danse, ne t'arrêt pas
...
Je bois en ta mémoire
En attendant, le ciel est noir
Il est bien dans mes bras (Il est bien dans mes bras)
Il y restera ou pas ?

[Refrain]
Danse, ne vois-tu pas (Danse, ne vois-tu pas)
...
But my life has been so overprotected"""
    ...
    "quelquun-pour-toi": {
        ...
        "lyrics": """Bien sûr les temps sont durs
On dit que rien ne dure, pourquoi pas
La ride et la rupture ont juste une autre allure qu'autre fois
Bien sûr t'as le vertige fatal et tes litiges n'attendent pas
Et tu dis que c'est trop tard, que t'as raté le départ

L'amour c'est pas dans ton histoire

Ouh ouh ouh
Ouh ouh ouh
Là dans la foule il y'a quelqu'un pour toi
Ouh ouh ouh
Ouh ouh ouh
...
Il y'a quelqu'un là dans la foule qui n'attend que toi
C'est un inconnu plein d'amour, peut-être un ami de toujours
Juste caché là dans la foule, y'a quelqu'un pour toi
Y'a quelqu'un pour toi

Bien sûr que tu l'mérites, autant que tous ces autres qui s'aiemnt
Bien sûr t'es pas coupable, bien sûr que t'es capable puisqu'humaine
T'es de la dynamite yeah, pas de favorite à ce game
...
Nu?"""
    ...
    "settle-for-me": {
        "helpers": ['settle', 'condom', 'beef', 'masculinity', 'flesh'],
        "lyrics": """[GREG]
When we’re together
I feel so grand
...
Settle for me!"""
    ...
    "seventeen": {
        "helpers": ['damaged', 'normal', 'seventeen', 'dancing', 'tonight'],
        "lyrics": """[VERONICA]
...
You're the one I choose"""
    ...
    "sex-with-a-stranger": {
        "helpers": ['stranger', 'murderer', 'tested', 'kidney', 'dishes'],
        "lyrics": """[REBECCA]
Steppin' in the club
...
I promise I'll be back, okay, see you in a second, bye!"""
    ...
    "sexy-french-depression": {
        "helpers": ['depression', 'grout', 'tampon', 'dessert', 'garbage'],
        "lyrics": """[REBECCA]
...
I'm in a sexy French depression"""
    ...
    "sexy-getting-ready-song": {
        "helpers": ['ready', 'silhouette', 'blood', 'apologize', 'feminine'],
        "lyrics": """[REBECCA]
Oooh
Oh-oh
...
(spoken)
God, what... this is how you get ready? This is some... this is horrifying, like a scary movie or something. Like some nasty-ass patriarchal *bleep*. You know what? I gotta go apologize to some bitches. I'm forever changed after what I've just seen.
...
The sexy getting ready song"""
    ...
    "slow-motion": {
        "helpers": ['motion', 'cool', 'hair', 'sunglasses', 'boring'],
        "lyrics": """[REBECCA, PAULA, VALENCIA & HEATHER]
Slow motion
Slow motion
...
Damn, we're out of the room!"""
    ...
    "so-maternal": {
        ...
        "lyrics": """[Parenting podcast host:]
On today's episode, we're talking allergies. Peanuts, dairy, eggs...how do we let kids be kids, but still keep them safe?
...
[Parenting podcast host:]
You're listening to "mom time daily." And we're so honored to have super-mom Rebecca bunch here on our podcast today
Rebecca, you are one of the most incredible moms I have ever seen, even though you don't have any children and you've only been babysitting for less than an hour. How do you do it?
...
Es que quando me acerco, tú te alejas más de mí
...
Entiéndeme, te pido explicación
Because me estás matando y destruyendo la razón
Ya me cansé, no quiero insistir
...
Oh, the live stream's almost on"""
    ...
    "to-idio-to-theo": {
        "helpers": ['Θεό', 'αγάπη', 'ζωή', 'αγκαλιά', 'κόλαση'],
        "lyrics": """Πάνω σου η γη ξυπνάει
...
Τον ίδιο το Θεό"""
    ...
    "toi-mon-amour": {
        ...
        "lyrics": """Toi mon amour, toi qui a le cœur lourd mon amour
...
Mais tu grandiras comme tous les autres hommes avant toi"""
    ...
    "u-mamy-est-sekret": {
        ...
        "lyrics": """[Куплет 1: Монеточка & Витя Исаев]
...
У мамы есть…
О-о-а (Эй, эй, эй)
О-о-о, у мамы есть секрет (А)
У мамы есть секрет (А)
У мамы есть… (А)
О-о-а
У мамы есть секрет (О-о, а)
У мамы есть секрет (О-о, а)
...
У мамы есть секрет"""
    ...
    "un-premier-amour": {
        ...
        "lyrics": """Un premier amour, premier amour, premier amour
...
These gestes innocents nous engageaient pour si longtemps?
...
Un raggio di sole, un raggio di sole per te"""
    ...
    "unatta-estate": {
        ...
        "lyrics": """[Strofa 1]
Lo vedi? Arriva un'altra estate (Ah)
Lo so, non ci credevi più (Ah)
Che è stato buio l’inverno, troppo duro, un inferno (Ah)
E così immobile la primavera (Ah)

[Pre-Ritornello 1]
Ma tu ora dove sei? (Ah, ah, ah, ah)
Dimmi dove sei (Ah, ah)
Che oggi ti porto via

[Ritornello]
E ce ne andiamo al mare (Oh)
Chissà che effetto fa (Chissà che effetto fa) (Oh)
Vediamo se questo tempo ci rincuora (Ah, oh)
Se questa estate ci consola (Ah, oh)

[Strofa 2]
Lo vedi, amico? Arriva un'altra estate (Ah)
E ormai chi ci credeva più (Ah)
Che è stato duro l'inferno, ma non scaldava l'inverno (Ah)
Hai pianto troppo questa primavera (Ah)
...
Io ci credo ancora (Oh, oh, oh, oh, ah, oh, oh)

[Outro]
E ce ne andiamo al mare (Ah, ah, ah)
Chissà che effetto fa (Lo vedi? Arriva una tempesta) (Ah, ah, ah, ah)
E ce ne andiamo al mare (Ah, ah, ah)
Chissà que effetto fa (Che poi magari ci consola) (Oh, oh)"""
    },
    "unlikely-lovers": {
...
[Dr. Charlotte and Cordelia enter the hospital room.]
...
Я тебя не знаю, знаю нас…"""
    ...
    "whatll-it-be": {
        "helpers": ['Covina', 'Thanksgiving', 'bar', 'beers', 'sunburned'],
        "lyrics": """[GREG]
...
[MAYA]
He's suspiciously good looking in ways
That normal people are not
...
Is this someone new we're going to
Have to grow to care about?
...
[ALL]
Who's the new guy?
What's his deal? What's his deal? What's his deal? What's his deal?
...
Karen shut up!"""
    ...
    "without-love-you-can-save-the-world": {
        "helpers": ['love', 'leukaemia', 'bulimia', 'leash', 'pandas'],
        "lyrics": """[REBECCA]
...
I could have used that time to cure leukaemia
...
Without love"""
    ...
    "women-gotta-stick-together": {
        "helpers": ['together', 'sisterhood', 'eyebrows', 'sausages', 'sushi'],
        "lyrics": """[VALENCIA]
Women gotta stick together
Each and every day
Women gotta stick together
...
And that's called sisterhood"""
    ...
    "you-stupid-bitch": {
        "helpers": ['ruined', 'Karma', 'boulder', 'shards', 'metaphor'],
        "lyrics": """[REBECCA]
Well, Rebecca, you've done it now
