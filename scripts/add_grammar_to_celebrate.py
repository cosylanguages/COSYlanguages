...
DATABASE = {
    ...
    "urban-beekeeping-day-elementary.html": {
        "level": "Elementary (A2)",
        "focus": "Quantifiers",
        "explanation": "<strong>Quantifiers</strong> (<em>many, some, few, a lot of, much, any</em>) are words used before a noun to express quantity or amount.",
        "rule_part_a_html": "Complete the rule: We use <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"many\">_____</span> with plural countable nouns (like bees), and <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"much\">_____</span> with uncountable nouns (like honey). We use <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"some\">_____</span> or <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"a lot of\">_____</span> in positive sentences for both types.",
        "rule_answers": "many, much, some, a lot of",
        "tasks": [
            "There are <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"many\">_____</span> beautiful flowers in our urban garden.",
            "The beekeeper does not have <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"much\">_____</span> honey left in this hive.",
            "We planted <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"some\">_____</span> wild green plants on our balcony.",
            "Our local community has <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"a lot of\">_____</span> useful tools for gardening.",
            "Very <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"few\">_____</span> people know how to build a wooden hive."
        ],
        "chips": ["many", "much", "some", "a lot of", "few", "any"],
        "speaking": "Talk about green spaces in your city. Are there many parks? Do you have any plants at home?",
        "r1": [
            {"main": "Are there <strong>many</strong> green spaces in your <strong>urban</strong> neighborhood?", "personal": "Do you prefer living in urban cities or quiet villages?"},
            {"main": "Do you know of <strong>any</strong> clever ways to <strong>protect</strong> bees from city pollution?", "personal": "Do you buy eco-friendly products to help protect the earth?"},
            {"main": "Why do <strong>some</strong> families choose to put a wooden <strong>hive</strong> on their balcony?", "personal": "Have you ever seen a real hive with active bees?"},
            {"main": "Does city noise cause <strong>much</strong> damage to the local <strong>environment</strong>?", "personal": "Do you try to recycle your plastic bottles to keep the environment clean?"},
            {"main": "Why do <strong>a lot of</strong> citizens join their local <strong>community</strong> to build gardens?", "personal": "Are you active in your local neighborhood community?"},
            {"main": "Are there only a <strong>few</strong> <strong>wild</strong> flowers left in neat city parks?", "personal": "When was the last time you walked in a wild forest?"},
            {"main": "Does a modern <strong>beekeeper</strong> need to spend <strong>much</strong> time learning their skills?", "personal": "Would you like to try the work of a beekeeper for one day?"},
            {"main": "Is growing green vegetables <strong>some</strong>one's favorite <strong>hobby</strong> in your country?", "personal": "What is your favorite outdoor hobby?"},
            {"main": "Do you keep <strong>many</strong> delicate <strong>plant</strong> pots on your bedroom desk?", "personal": "Do you prefer green houseplants or colorful flowers?"},
            {"main": "Why are insects like honey bees so <strong>useful</strong> for growing <strong>many</strong> foods?", "personal": "What is the most useful tip you learned about saving electricity?"}
        ],
        "r2": [
            {"main": "In the future, every <strong>urban</strong> school will have <strong>some</strong> honey <strong>hive</strong> structures for students.", "personal": "Would you support having a bee <strong>hive</strong> at your local school?"},
            {"main": "Governments will pay <strong>some</strong> citizens to <strong>protect</strong> rare wild flowers on balconies.", "personal": "Would you grow more flowers if the government paid you?"},
            {"main": "There will be <strong>few</strong> wild spaces left if we do not protect the natural <strong>environment</strong>.", "personal": "Would you want to live in a clean virtual city if the real world became too polluted?"},
            {"main": "Every local <strong>community</strong> will grow <strong>a lot of</strong> organic food on vertical walls.", "personal": "Do you think vertical walls are a <strong>useful</strong> way to grow food?"},
            {"main": "Very <strong>few</strong> people will choose beekeeping as their primary outdoor <strong>hobby</strong>.", "personal": "Would you tell your friends if your new <strong>hobby</strong> was keeping bees?"},
            {"main": "We will build <strong>many</strong> gigantic artificial trees to clean the <strong>urban</strong> air.", "personal": "Do you think artificial trees are <strong>useful</strong> or a waste of money?"},
            {"main": "A robotic <strong>plant</strong> will require <strong>any</strong> electrical power to clean apartment dust.", "personal": "Would you buy a robotic <strong>plant</strong> or a real green fern?"},
            {"main": "City laws will not allow <strong>any</strong> chemical sprays to save <strong>wild</strong> insects.", "personal": "Do you actively avoid chemical sprays in your household?"},
            {"main": "Every citizen will have to spend <strong>some</strong> hours helping their <strong>community</strong> in local parks.", "personal": "Would you enjoy spending a weekend cleaning parks with your neighbors?"},
            {"main": "Scientists will place <strong>a lot of</strong> tracking chips on bees to <strong>protect</strong> hives.", "personal": "Do you think tracking queen bees is <strong>useful</strong> for science?"}
        ]
    },
    "diwali-festival.html": {
        "level": "Intermediate (B1)",
        "focus": "Passive Voice",
        "explanation": "The <strong>Passive Voice</strong> is used when the focus is on the action or the object of the action, rather than who performs it. It is formed using <em>to be + past participle</em>.",
        "rule_part_a_html": "Complete the rule: We form the passive voice with the appropriate tense of the verb <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"to be\">_____</span> followed by the <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"past participle\">_____</span> of the main verb. If we want to mention who performed the action, we use the preposition <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"by\">_____</span>.",
        "rule_answers": "to be, past participle, by",
        "tasks": [
            "Before the holiday starts, every room <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"is cleansed\">_____</span> thoroughly.",
            "Traditional oil lamps <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"are lit\">_____</span> to welcome prosperity.",
            "A grand celebratory feast <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"was prepared\">_____</span> by our hosts last night.",
            "This ancient mythology <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"has been passed\">_____</span> down through generations.",
            "Thousands of colorful firecrackers <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"were set off\">_____</span> in the main square."
        ],
        "chips": ["to be", "past participle", "by", "is cleansed", "are lit", "was prepared", "has been passed", "were set off"],
        "speaking": "Describe how your favorite holiday is celebrated in your country. What traditional foods are served, and what customs are practiced?",
        "r1": [
            {"main": "Why <strong>is</strong> Diwali <strong>celebrated</strong> with such vibrant light and joy by families around the world?", "personal": "Are there any multi-religious festivals in your country?"},
            {"main": "How <strong>is</strong> a colorful <strong>rangoli</strong> pattern <strong>created</strong> at the house entrance, and what does it represent?", "personal": "Do you have any long multi-day celebrations in your culture?"},
            {"main": "Why <strong>is</strong> <strong>prosperity</strong> <strong>associated</strong> with the arrival of the goddess Lakshmi during the festival?", "personal": "Do you usually clean your home before a big holiday?"},
            {"main": "What traditional sweets <strong>are</strong> <strong>served</strong> during this public <strong>festivity</strong>?", "personal": "What is the most common gift in your culture?"},
            {"main": "In many cities, why <strong>have</strong> loud <strong>firecrackers</strong> <strong>been limited</strong> due to environmental concerns?", "personal": "Do you prefer fixed dates or lunar dates for holidays?"},
            {"main": "Why <strong>is</strong> exceptional <strong>hospitality</strong> <strong>offered</strong> to neighbors and strangers during Diwali?", "personal": "Do you usually buy new clothes for special occasions?"},
            {"main": "How <strong>has</strong> ancient <strong>mythology</strong> <strong>been kept</strong> alive through the centuries by oral storytelling?", "personal": "Are there any \"unusual\" traditions in your family?"},
            {"main": "What local dishes <strong>are</strong> <strong>prepared</strong> when families gather for a grand <strong>feast</strong>?", "personal": "How do you welcome guests into your home?"},
            {"main": "Why <strong>must</strong> homes <strong>be cleansed</strong> before the festival is officially started?", "personal": "Does your favorite holiday have more than one name?"},
            {"main": "How <strong>is</strong> the deep <strong>symbolism</strong> of light conquering darkness understood in different cultures?", "personal": "Which festival brings the most people together in your country?"}
        ],
        "r2": [
            {"main": "Traditional <strong>firecrackers</strong> <strong>will be banned</strong> globally in the future to protect city air quality.", "personal": "Would you miss <strong>firecrackers</strong> if they were replaced by silent laser shows?"},
            {"main": "The spiritual and <strong>mythology</strong> meanings of ancient festivals <strong>will be overshadowed</strong> by intense commercialization.", "personal": "Do you think gift-giving is the most important part of a <strong>mythology</strong> celebration?"},
            {"main": "In the future, the traditional <strong>feast</strong> <strong>will be replaced</strong> by virtual family dinners over video calls.", "personal": "Have you ever celebrated a grand <strong>feast</strong> from a culture that wasn't your own?"},
            {"main": "A new universal <strong>symbolism</strong> of light <strong>will be created</strong> as different global traditions merge.", "personal": "Should your country have more public holidays for different religions to share their <strong>symbolism</strong>?"},
            {"main": "Red envelopes and wishes for <strong>prosperity</strong> <strong>will be sent</strong> exclusively through cryptocurrency apps.", "personal": "Do you prefer a physical card wishing you <strong>prosperity</strong> or a digital message?"},
            {"main": "Handmade art forms like <strong>rangoli</strong> <strong>will be protected</strong> by law as cultural treasures.", "personal": "Do you value handmade art forms like <strong>rangoli</strong> more if you know they were made by hand?"},
            {"main": "Homes <strong>will be cleansed</strong> and decorated entirely by domestic robots before holidays.", "personal": "How often do you <strong>cleanse</strong> your digital life of clutter?"},
            {"main": "New globally shared moments of <strong>festivity</strong> <strong>will be established</strong> through social media fusion.", "personal": "What is your favorite example of cultural fusion and shared <strong>festivity</strong>?"},
            {"main": "Physical <strong>diyas</strong> and oil lamps <strong>will be replaced</strong> by interactive, high-tech LED projections.", "personal": "Why do humans find hope in the symbol of lighting traditional <strong>diyas</strong>?"},
            {"main": "Traditional family <strong>hospitality</strong> <strong>will be offered</strong> only as a paid, professional homestay service.", "personal": "What is the most memorable act of <strong>hospitality</strong> a stranger has ever shown to you?"}
        ]
    },
    ...
    "pandemonium-day-upper-intermediate.html": {
        ...
        "explanation": "<strong>Negative Inversion</strong> is used for emphasis or dramatic effect, especially in formal or written contexts. We place a negative adverb (<em>under no circumstances, seldom, little, rarely, not only</em>) at the start of the clause and invert the subject and auxiliary verb.",
        "rule_part_a_html": "Complete the rule: When we start a sentence with a negative or limiting adverb, we invert the subject and the auxiliary verb. For example, instead of 'He had rarely seen', we write 'Rarely <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"had he seen\">_____</span>'. Under no circumstances <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"should you\">_____</span> panic, and not only <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"did they\">_____</span> create chaos but they also broke schedules.",
        "rule_answers": "had he seen, should you, did they",
        "tasks": [
            "Seldom <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"have I witnessed\">_____</span> such absolute pandemonium in a public space.",
            "Under no circumstances <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"should we abandon\">_____</span> our daily schedules.",
            "Not only <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"did the crowd cause\">_____</span> confusion, but they also created friction.",
            "Little <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"did they realize\">_____</span> that their spontaneous trip would become messy.",
            "Rarely <span class=\"grammar-gap\" onclick=\"COSY.placeGrammarChip(this)\" data-answer=\"has a single event\">_____</span> caused so much disorder and tension."
        ],
        "chips": ["have I witnessed", "should we abandon", "did the crowd cause", "did they realize", "has a single event", "had he seen", "should you", "did they"],
        "speaking": "Describe a highly chaotic event you experienced. Start at least one sentence with 'Seldom have I...' or 'Little did I know...' to emphasize the drama!",
        "r1": [
            {"main": "Seldom <strong>have we seen</strong> such pure <strong>pandemonium</strong> in modern cities; what historical events come to mind?", "personal": "Do you find historical biographies or fictional accounts of chaos more compelling?"},
            {"main": "Not only <strong>did a flash mob erupt</strong> in the street, but it also dissolved all sense of <strong>chaos ≠ order</strong>.", "personal": "What is the most unexpected public disruption you have ever witnessed in person?"},
            {"main": "Little <strong>did they suspect</strong> that abandoning their rigid <strong>schedule</strong> would lead to such thrilling spontaneity.", "personal": "How do you cope when a carefully planned itinerary completely falls apart?"},
            {"main": "Rarely <strong>had the city experienced</strong> such <strong>disorder</strong>, yet people found creative ways to resolve the tension.", "personal": "What is your primary survival strategy during a power outage or natural disruption?"},
            {"main": "Under no circumstances <strong>should an unpredictable</strong> career choice be feared if it offers genuine growth.", "personal": "Have you ever made a major life decision that felt like a complete gamble?"},
            {"main": "Not only <strong>did they enjoy</strong> spontaneous <strong>laughter</strong>, but they also reduced their stress significantly.", "personal": "How important is humor and laughter in your professional life?"},
            {"main": "Seldom <strong>has a dense crowd</strong> created so much positive energy without causing any physical <strong>friction</strong>.", "personal": "Do you actively avoid crowded public events, or do you thrive in busy spaces?"},
            {"main": "Little <strong>did our ancestors know</strong> that their lack of social <strong>structure</strong> would inspire future minimalist movements.", "personal": "Do you believe humans are naturally cooperative or inherently competitive?"},
            {"main": "Rarely <strong>have employees complained</strong> about a <strong>hectic</strong> environment when their voices were actively heard.", "personal": "Have you ever had to manage a project that was in complete disarray?"},
            {"main": "Under no circumstances <strong>should we allow</strong> absolute <strong>disorder</strong> to override the safety of public facilities.", "personal": "How often do you pay attention to emergency exits when entering a new building?"}
        ],
        "r2": [
            {"main": "Rarely <strong>have smart-grid engineers faced</strong> a solar storm that caused such immediate <strong>chaos</strong>.", "personal": "How dependent is your daily routine on a stable internet connection?"},
            {"main": "Seldom <strong>would humanity have adopted</strong> standardized calendars if our schedules were completely <strong>unpredictable</strong>.", "personal": "Do you think we rely too heavily on precise timekeeping?"},
            {"main": "Not only <strong>did urban planners prioritize</strong> green corridors, but they also made the city much more <strong>orderly</strong>.", "personal": "Does your city's layout feel logical to you, or does it feel chaotic?"},
            {"main": "Under no circumstances <strong>should a dense crowd</strong> enter the stadium without security checks.", "personal": "What measures should event organizers take to ensure crowd safety?"},
            {"main": "Little <strong>did the public realize</strong> that widespread <strong>pandemonium</strong> would erupt so quickly after the collapse.", "personal": "Do you believe governments should withhold bad news to prevent panic?"},
            {"main": "Not only <strong>has the slow-living movement gained</strong> traction, but it has also simplified our <strong>schedules</strong>.", "personal": "How do you actively protect your personal time from work demands?"},
            {"main": "Seldom <strong>will citizens experience</strong> visual <strong>disorder</strong> if developers build larger municipal parks.", "personal": "How does the presence of green spaces affect your mental well-being?"},
            {"main": "Rarely <strong>has global trade functioned</strong> smoothly without the stable <strong>structure</strong> of international law.", "personal": "What is the most important international agreement in your opinion?"},
            {"main": "Under no circumstances <strong>should public authorities ignore</strong> protests before they escalate into absolute <strong>chaos</strong>.", "personal": "At what point does public protest cross the line into unacceptable disorder?"},
            {"main": "Little <strong>did we anticipate</strong> that a single global currency would make the transition so <strong>orderly</strong>.", "personal": "Would a single global currency be beneficial or detrimental to less developed nations?"}
        ]
    }
}
