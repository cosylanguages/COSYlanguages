...
(function() {
    ...
    const QUESTIONS = {
        EN: {
            ...
            Grammar: [
                {"type": "mc", "q": "She ___ a talented doctor.", "opts": ["is", "are", "am", "be"], "ans": 0, "level": "starter", "theme": "to-be", "ruleHint": "Use \"is\" for third person singular (he/she/it).", "practice_links": ["manuals/en/grammar/a1/topics/to-be.html"]},
                {"type": "mc", "q": "They ___ ready for the lesson yet.", "opts": ["aren't", "isn't", "am not", "not are"], "ans": 0, "level": "starter", "theme": "to-be", "ruleHint": "Use \"aren't\" (are not) for plural subjects.", "practice_links": ["manuals/en/grammar/a1/topics/to-be.html"]},
                {"type": "mc", "q": "___ you a student at this university?", "opts": ["Are", "Is", "Am", "Be"], "ans": 0, "level": "starter", "theme": "to-be", "ruleHint": "Invert \"Are\" and subject \"you\" for questions.", "practice_links": ["manuals/en/grammar/a1/topics/to-be.html"]},
                {"type": "mc", "q": "He ___ to work by bus every morning.", "opts": ["goes", "go", "going", "is go"], "ans": 0, "level": "starter", "theme": "present-simple", "ruleHint": "Add -s/-es to third person singular in Present Simple.", "practice_links": ["manuals/en/grammar/a1/topics/present-simple.html"]},
                {"type": "mc", "q": "We ___ coffee in the evening.", "opts": ["don't drink", "doesn't drink", "not drink", "aren't drink"], "ans": 0, "level": "starter", "theme": "present-simple", "ruleHint": "Use \"don't\" for negative present simple with I/we/you/they.", "practice_links": ["manuals/en/grammar/a1/topics/present-simple.html"]},
                {"type": "mc", "q": "Where ___ your sister live?", "opts": ["does", "do", "is", "are"], "ans": 0, "level": "starter", "theme": "present-simple", "ruleHint": "Use auxiliary \"does\" for third person singular questions.", "practice_links": ["manuals/en/grammar/a1/topics/present-simple.html"]},
                {"type": "mc", "q": "Listen! The baby ___ right now.", "opts": ["is crying", "cries", "cried", "cry"], "ans": 0, "level": "starter", "theme": "present-continuous", "ruleHint": "Use present continuous (be + -ing) for actions happening now.", "practice_links": ["manuals/en/grammar/a1/topics/present-continuous.html"]},
                {"type": "mc", "q": "Look at them! They ___ in the park.", "opts": ["are running", "runs", "is running", "runned"], "ans": 0, "level": "starter", "theme": "present-continuous", "ruleHint": "Use \"are + verb-ing\" for plural present continuous.", "practice_links": ["manuals/en/grammar/a1/topics/present-continuous.html"]},
                {"type": "mc", "q": "I saw ___ elephant at the zoo.", "opts": ["an", "a", "the", "some"], "ans": 0, "level": "starter", "theme": "articles", "ruleHint": "Use \"an\" before words starting with a vowel sound.", "practice_links": ["manuals/en/grammar/a1/topics/articles.html"]},
                {"type": "mc", "q": "He is ___ honest man.", "opts": ["an", "a", "the", "--"], "ans": 0, "level": "starter", "theme": "articles", "ruleHint": "\"honest\" begins with a silent h, so use \"an\".", "practice_links": ["manuals/en/grammar/a1/topics/articles.html"]},
                {"type": "mc", "q": "___ sun rises in the east.", "opts": ["The", "A", "An", "--"], "ans": 0, "level": "starter", "theme": "articles", "ruleHint": "Use \"The\" for unique celestial bodies and natural phenomena.", "practice_links": ["manuals/en/grammar/a1/topics/articles.html"]},
                {"type": "mc", "q": "Two ___ were parked outside.", "opts": ["buses", "buss", "buseses", "bus"], "ans": 0, "level": "starter", "theme": "plurals-regular", "ruleHint": "Nouns ending in -s add -es in plural.", "practice_links": ["manuals/en/grammar/a1/topics/plurals-regular.html"]},
                {"type": "mc", "q": "Three ___ were playing in the garden.", "opts": ["children", "childs", "childes", "childrens"], "ans": 0, "level": "starter", "theme": "plurals-irregular", "ruleHint": "Irregular plural of child is children.", "practice_links": ["manuals/en/grammar/a1/topics/plurals-irregular.html"]},
                {"type": "mc", "q": "The laptop is resting ___ the wooden desk.", "opts": ["on", "in", "at", "to"], "ans": 0, "level": "starter", "theme": "prepositions-place", "ruleHint": "Use \"on\" for surfaces.", "practice_links": ["manuals/en/grammar/a1/topics/prepositions-place.html"]},
                {"type": "mc", "q": "Our train arrives ___ 8:30 PM sharp.", "opts": ["at", "in", "on", "for"], "ans": 0, "level": "starter", "theme": "prepositions-time", "ruleHint": "Use \"at\" for exact times.", "practice_links": ["manuals/en/grammar/a1/topics/prepositions-time.html"]},
                {"type": "mc", "q": "She was born ___ July.", "opts": ["in", "on", "at", "by"], "ans": 0, "level": "starter", "theme": "prepositions-time", "ruleHint": "Use \"in\" for months.", "practice_links": ["manuals/en/grammar/a1/topics/prepositions-time.html"]},
                {"type": "mc", "q": "Yesterday, we ___ around the lake.", "opts": ["walked", "walk", "walking", "walks"], "ans": 0, "level": "starter", "theme": "past-simple-regular", "ruleHint": "Regular past simple verbs take -ed.", "practice_links": ["manuals/en/grammar/a1/topics/past-simple-regular.html"]},
                {"type": "mc", "q": "She ___ a new laptop last weekend.", "opts": ["bought", "buyed", "buys", "buying"], "ans": 0, "level": "starter", "theme": "past-simple-irregular", "ruleHint": "Irregular past form of buy is bought.", "practice_links": ["manuals/en/grammar/a1/topics/past-simple-irregular.html"]},
                {"type": "mc", "q": "If you heat ice, it ___.", "opts": ["melts", "melted", "will melt", "is melting"], "ans": 0, "level": "elementary", "theme": "zero-conditional", "ruleHint": "Zero conditional states general scientific facts: If + Present Simple, Present Simple.", "practice_links": ["manuals/en/grammar/a2/topics/zero-conditional.html"]},
                {"type": "mc", "q": "If it rains tomorrow, we ___ at home.", "opts": ["will stay", "stay", "stayed", "would stay"], "ans": 0, "level": "elementary", "theme": "first-conditional", "ruleHint": "First conditional for future possibilities: If + Present Simple, Will + Verb.", "practice_links": ["manuals/en/grammar/a2/topics/first-conditional.html"]},
                {"type": "mc", "q": "If I ___ rich, I would buy a boat.", "opts": ["were", "am", "will be", "had been"], "ans": 0, "level": "elementary", "theme": "second-conditional", "ruleHint": "Second conditional uses Past Simple (were/had) for unreal present conditions.", "practice_links": ["manuals/en/grammar/a2/topics/second-conditional.html"]},
                {"type": "mc", "q": "If you had called me, I ___ you.", "opts": ["would have helped", "helped", "will help", "would help"], "ans": 0, "level": "intermediate", "theme": "third-conditional", "ruleHint": "Third conditional uses If + Past Perfect, Would Have + Past Participle for unreal past.", "practice_links": ["manuals/en/grammar/b1/topics/third-conditional.html"]}
            ]
        },
        FR: {
            Vocabulary: [
