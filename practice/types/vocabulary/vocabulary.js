...
(function() {
    ...
    const QUESTIONS = {
        EN: {
            ...
            Grammar: [
                // Level A1 Part 1 — Building Blocks (numbers-dates, telling-time, english-around-world)
                // Numbers, Days & Months (numbers-dates)
                { type:'mc', q:'What is the ordinal form of the number 3?', opts:['third','threeth','3th','thir'], ans:0, level:'starter', theme:'numbers-dates', ruleHint:'3 ➔ third is an irregular ordinal number.', practice_links:['manuals/en/grammar/a1/topics/numbers-dates.html'] },
                { type:'mc', q:'Which day comes immediately after Wednesday?', opts:['Thursday','Tuesday','Friday','Saturday'], ans:0, level:'starter', theme:'numbers-dates', ruleHint:'The days of the week are Monday, Tuesday, Wednesday, Thursday, Friday...', practice_links:['manuals/en/grammar/a1/topics/numbers-dates.html'] },
                { type:'mc', q:'Which month comes right before August?', opts:['July','June','September','October'], ans:0, level:'starter', theme:'numbers-dates', ruleHint:'July is the 7th month, coming immediately before August.', practice_links:['manuals/en/grammar/a1/topics/numbers-dates.html'] },
                { type:'mc', q:'How is the "-teen" vs "-ty" stress pronounced correctly?', opts:['thir-TEEN vs THIR-ty','THIR-teen vs thir-TY','thir-teen vs thir-ty','THIR-TEEN vs THIR-TY'], ans:0, level:'starter', theme:'numbers-dates', ruleHint:'-teen numbers stress the second syllable, while -ty numbers stress the first.', practice_links:['manuals/en/grammar/a1/topics/numbers-dates.html'] },
                { type:'tf', q:'In phone numbers, repeated digits are spoken using "double" (e.g. 07700 double nine).', ans:true, level:'starter', theme:'numbers-dates', ruleHint:'Phone numbers in English use "double" for repeated digits.', practice_links:['manuals/en/grammar/a1/topics/numbers-dates.html'] },
                { type:'cloze', q:'Fill in the blank: Her birthday is on the [ ___ ] of May.', sentence:'Her birthday is on the [ ___ ] of May.', opts:['fifteenth','fifteen','fiveth','fifteens'], ans:0, level:'starter', theme:'numbers-dates', ruleHint:'Dates use ordinal numbers like 15th (fifteenth).', practice_links:['manuals/en/grammar/a1/topics/numbers-dates.html'] },
                { type:'type', q:'"Ordinal form of 21" = ?', ans:'twenty-first', level:'starter', theme:'numbers-dates', ruleHint:'21 ➔ twenty-first.', item:{ word:'twenty-first' }, practice_links:['manuals/en/grammar/a1/topics/numbers-dates.html'] },
                { type:'sc', q:'🧩 Reorder the date:', ans:'My birthday is on the fifth of June.', level:'starter', theme:'numbers-dates', item:{ word:'Date Order' }, practice_links:['manuals/en/grammar/a1/topics/numbers-dates.html'] },

                // Telling the Time (telling-time)
                { type:'mc', q:'How do you say "3:15" in traditional clock format?', opts:['quarter past three','half past three','quarter to three','three past fifteen'], ans:0, level:'starter', theme:'telling-time', ruleHint:'15 minutes past the hour is "quarter past".', practice_links:['manuals/en/grammar/a1/topics/telling-time.html'] },
                { type:'mc', q:'How do you say "3:45" in traditional clock format?', opts:['quarter to four','quarter past three','half past three','fifteen to three'], ans:0, level:'starter', theme:'telling-time', ruleHint:'45 minutes past 3 is 15 minutes before 4: "quarter to four".', practice_links:['manuals/en/grammar/a1/topics/telling-time.html'] },
                { type:'mc', q:'Which question is correct to ask for the current time?', opts:['What time is it?','What hour is it?','Which time you have?','How much clock is it?'], ans:0, level:'starter', theme:'telling-time', ruleHint:'Ask "What time is it?" or "What\'s the time?".', practice_links:['manuals/en/grammar/a1/topics/telling-time.html'] },
                { type:'mc', q:'How is "8:30" expressed in natural English?', opts:['half past eight','three and a half','eight half','half to eight'], ans:0, level:'starter', theme:'telling-time', ruleHint:'30 minutes past the hour is expressed as "half past".', practice_links:['manuals/en/grammar/a1/topics/telling-time.html'] },
                { type:'tf', q:'"1/4" as a fraction in English is spoken as "a quarter".', ans:true, level:'starter', theme:'telling-time', ruleHint:'1/4 is spoken as "a quarter" or "one quarter".', practice_links:['manuals/en/grammar/a1/topics/telling-time.html'] },
                { type:'cloze', q:'Fill in the blank: The English lesson starts [ ___ ] half past nine.', sentence:'The English lesson starts [ ___ ] half past nine.', opts:['at','in','on','for'], ans:0, level:'starter', theme:'telling-time', ruleHint:'Use "at" before clock times.', practice_links:['manuals/en/grammar/a1/topics/telling-time.html'] },
                { type:'type', q:'In traditional clock time, 7:15 = "quarter past ___"?', ans:'seven', level:'starter', theme:'telling-time', ruleHint:'7:15 ➔ quarter past seven.', item:{ word:'seven' }, practice_links:['manuals/en/grammar/a1/topics/telling-time.html'] },
                { type:'sc', q:'🧩 Reorder the question:', ans:'What time does the movie start?', level:'starter', theme:'telling-time', item:{ word:'Time Question' }, practice_links:['manuals/en/grammar/a1/topics/telling-time.html'] },

                // English Around the World (english-around-world)
                { type:'mc', q:'Which is the US word for British "flat"?', opts:['apartment','house','room','building'], ans:0, level:'starter', theme:'english-around-world', ruleHint:'Flat (UK) = apartment (US).', practice_links:['manuals/en/grammar/a1/topics/english-around-world.html'] },
                { type:'mc', q:'Which is the US word for British "holiday"?', opts:['vacation','weekend','break','trip'], ans:0, level:'starter', theme:'english-around-world', ruleHint:'Holiday (UK) = vacation (US).', practice_links:['manuals/en/grammar/a1/topics/english-around-world.html'] },
                { type:'mc', q:'How do British speakers usually express "on the weekend"?', opts:['at the weekend','in the weekend','for the weekend','by the weekend'], ans:0, level:'starter', theme:'english-around-world', ruleHint:'UK usage prefers "at the weekend", while US prefers "on the weekend".', practice_links:['manuals/en/grammar/a1/topics/english-around-world.html'] },
                { type:'mc', q:'In American spelling, "colour" is written as:', opts:['color','colur','colore','culor'], ans:0, level:'starter', theme:'english-around-world', ruleHint:'UK -our endings correspond to US -or endings (colour ➔ color).', practice_links:['manuals/en/grammar/a1/topics/english-around-world.html'] },
                { type:'tf', q:'In UK and Australian English, numeric dates are written as day/month/year (e.g. 5/7/2026 = 5 July).', ans:true, level:'starter', theme:'english-around-world', ruleHint:'UK/AU order is day/month/year; US order is month/day/year.', practice_links:['manuals/en/grammar/a1/topics/english-around-world.html'] },
                { type:'cloze', q:'Fill in the blank: "I have got a new car" is the standard [ ___ ] everyday spoken expression for possession.', sentence:'"I have got a new car" is the standard [ ___ ] everyday spoken expression for possession.', opts:['British','American','Canadian','Australian'], ans:0, level:'starter', theme:'english-around-world', ruleHint:'"Have got" for possession is predominantly British usage.', practice_links:['manuals/en/grammar/a1/topics/english-around-world.html'] },
                { type:'type', q:'American English word for British "autumn" = ?', ans:'fall', level:'starter', theme:'english-around-world', ruleHint:'Autumn (UK) = fall (US).', item:{ word:'fall' }, practice_links:['manuals/en/grammar/a1/topics/english-around-world.html'] },
                { type:'sc', q:'🧩 Reorder the sentence:', ans:'See you at the weekend in London.', level:'starter', theme:'english-around-world', item:{ word:'UK Phrase' }, practice_links:['manuals/en/grammar/a1/topics/english-around-world.html'] },
