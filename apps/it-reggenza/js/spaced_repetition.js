/**
 * Spaced Repetition Store & Progress Persistence for it-reggenza
 * Uses localStorage to track mastery level (0-5), due dates, streaks, and SRS intervals.
 */

class SpacedRepetitionStore {
    constructor() {
        this.progressKey = 'cosy-it-reggenza-progress';
        this.streakKey = 'cosy-it-reggenza-streak';
        this.goalKey = 'cosy-it-reggenza-goal';
