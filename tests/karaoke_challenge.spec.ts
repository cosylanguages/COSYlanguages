...
test.describe('Karaoke Club Challenge Tabbed layout Verification', () => {
  test('Maëlle Challenge page should load with correct metadata and tab layout', async ({ page }) => {
    await page.goto('http://localhost:8080/apps/premium-events/nights/karaoke/sessions/karaoke-club/challenges/fr/maelle-challenge/index.html');
    ...
    // 2. Tab buttons should exist (3 songs in Maëlle challenge)
    ...
    // 4. Check that default visible tab is Toutes les machines ont le cœur and others are hidden
    ...
    await expect(page.locator('#vocabulary-flash')).toBeAttached();
  ...
  test('Crazy Ex-Girlfriend Challenge page should load with 26 tabs', async ({ page }) => {
    await page.goto('http://localhost:8080/apps/premium-events/nights/karaoke/sessions/karaoke-club/challenges/crazy-ex-girlfriend-challenge/index.html');
