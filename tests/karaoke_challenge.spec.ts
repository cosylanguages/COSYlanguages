...
test.describe('Karaoke Club Challenge Tabbed layout Verification', () => {
  test('Maëlle Challenge page should load with correct metadata and tab layout', async ({ page }) => {
    await page.goto('http://localhost:8080/apps/premium-events/nights/karaoke/sessions/karaoke-club/fr/maelle-challenge.html');
  ...
  test('Crazy Ex-Girlfriend Challenge page should load with 26 tabs', async ({ page }) => {
    await page.goto('http://localhost:8080/apps/premium-events/nights/karaoke/sessions/karaoke-club/crazy-ex-girlfriend-challenge.html');
