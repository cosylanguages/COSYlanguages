const translations = {
  ...
  el: {
    ...
    event_cinema_desc: "Παρακολουθήστε ταινίες από όλο τον κόσμο στην πρωτότυπη γλώσσα τους με υπότιτλους. Ένας πολύ καλός τρόπος για να βυθιστείτε στον πολιτισμό και να βελτιώσετε τις δεξιότητές σας στην ακρόαση.",
