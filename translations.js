const translations = {
  en: {
    ...
    // Russian Page
    gramota_dictionary: "Gramota.ru Dictionaries",
    gramota_dictionary_desc: "Explanatory and spelling dictionaries.",
    level_test: "Level Test",
    level_test_desc: "Take a test to determine your Russian language level.",
    lamoda: "Lamoda",
    lamoda_desc: "Online fashion store.",
    letual: "L'Etoile",
    letual_desc: "Cosmetics and perfumery.",
    auchan_ru: "Auchan",
    auchan_ru_desc: "Supermarket and grocery store.",
    // Greek Page
  ...
  ru: {
    ...
    level_test_desc: "Пройдите тест, чтобы определить свой уровень русского языка.",
    lamoda: "Lamoda",
