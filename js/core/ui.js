...
(function() {
    ...
    window.COSY_THEME_TREE = {
      ...
      food_drink:          ['fruit','vegetables','drinks','cooking','meals','snacks','diet','breakfast','meat','sweets','spices_condiments','kitchen_utensils','packaging'],
      furniture:           ['rooms','furniture_items','appliances','household_items','doors_locks','garden','bedroom','bathroom','utility_room'],
      diy_construction:    ['hand_tools','building_materials','carpentry','plumbing','electrical','masonry'],
      health_medicine:     ['symptoms','treatment','hospital','wellbeing','sport_injury','medications','safety_equipment'],
      ...
      nature:              ['landscape','weather','plants','seasons','sky','sea','camping'],
      numbers:             ['cardinal','ordinal','fractions','money','shapes','geometry'],
      people:              ['family','relationships','nationality','physical_desc','character','babies','kids','groups'],
      ...
      sports:              ['team_sports','individual','gym','outdoor','water_sports','track_field','ball_sports','racket_sports','gymnastics','combat_sports','strength_sports','equestrian','precision_sports','cycling','motor_sports','winter_sports','aerial_sports','mountain_sports'],
      ...
      art_culture:         ['art','literature','film','theatre','traditions','fine_arts','graphic_arts','crafts','photography'],
      psychology:          ['biases','cognitive_processes','behavior','psychoanalysis','concepts'],
      science:             ['physics_mechanics','optics','chemistry','laboratory','measuring_devices','biology'],
      astronomy:           ['celestial_bodies','astronomical_observation','astronautics','solar_system'],
