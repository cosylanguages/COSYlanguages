(function() {
    const data = [
    {
        "t": "Ha lakaet oc'h bet gant al lec'h ma'z oc'h bet savet da vezañ an hini ma'z oc'h",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_ha_lakaet_och_bet_gant_al_lech"
    },
    {
        "t": "An islonk etre an den ma'z oc'h hag an hini a ziskouezit d'ar bed",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_an_islonk_etre_an_den_maz_och_"
    },
    {
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_hag_an_dud_a_chech_penn-da-ben"
    },
    {
        "t": "Ar pezh ho peus desket diwar c'hwitadennoù ha n'ho pije ket gallet deskiñ diwar berzhioù mat",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_ar_pezh_ho_peus_desket_diwar_c"
    },
    {
        "t": "Ho liamm gant ar serteniz hag an douetañs",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_ho_liamm_gant_ar_serteniz_hag_"
    },
    {
        "t": "An traoù a zougit eus ho pugaleaj hep skianaat anezhañ",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_an_trao_a_zougit_eus_ho_pugale"
    },
    {
        "t": "Ar pezh a zifennfec'h memes ma koustfe un dra bennak deoc'h",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_ar_pezh_a_zifennfech_memes_ma_"
    },
    {
        "t": "Ar pezh a soñjit e vez kammveuzet gant an dud diwar-benn al levenez",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_ar_pezh_a_sojit_e_vez_kammveuz"
    },
    {
        "t": "Roll ar chañs en ho puhez",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_roll_ar_chas_en_ho_puhez"
    },
    {
        "t": "Hag-eñ e c'hall ar vallozh hag an emeurusted kenvevañ",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_hag-e_e_chall_ar_vallozh_hag_a"
    },
    {
        "t": "Ar pezh a dleet d'an dud o deus ho stummet",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_ar_pezh_a_dleet_dan_dud_o_deus"
    },
    {
        "t": "An dra dalvoudusañ a zo bet lavaret deoc'h biskoazh",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_an_dra_dalvoudusa_a_zo_bet_lav"
    },
    {
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_un_dra_bennak_er_vuhez_vodern_"
    },
    {
        "t": "An diforc'h etre bezañ e-unan ha bezañ digenvez",
        "h": [
    ...
    },
    {
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_petra_a_dalvez_beva_mat_hag-e_"
    },
    {
        "t": "Hag-eñ e fizieit en ho memor deoc'h-c'hwi",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_hag-e_e_fizieit_en_ho_memor_de"
    },
    {
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_an_aozadurio_hag-e_e_talvezont"
    },
    {
        "t": "An istorioù a gontit diwar ho penn",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_an_istorio_a_gontit_diwar_ho_p"
    },
    {
        "t": "Petra a dalvez ar gumuniezh en ur bed mbeget",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_petra_a_dalvez_ar_gumuniezh_en"
    },
    {
        "t": "Penaos e ouzit pegoulz fiziout en un den bennak",
        "h": [
        ...
        "level": "advanced",
        "theme": "misc",
        "id": "br_advanced_misc_misc_penaos_e_ouzit_pegoulz_fiziout"
    }
];
    const lang = "br";
