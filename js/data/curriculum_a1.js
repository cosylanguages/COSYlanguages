window.CURRICULUM_A1 = [
{
  id:'u1', num:1, color:'#3B82F6', label:'My Life Today',
  arc:'Daily routines → Work → Home → Money → Food → Tech → Free time → Community',
  lessons_count:10,
  grammar_summary:[
    {name:'Present Simple (all forms)', desc:'Full paradigm with frequency adverbs', ex:'"She usually works from home."'},
    {name:'Should / Shouldn\'t', desc:'Advice in health and daily life', ex:'"You should eat more vegetables."'},
    {name:'Have to / Don\'t have to', desc:'Obligation and lack of obligation', ex:'"I have to pay rent by Friday."'},
    {name:'Like / Love / Hate + -ing', desc:'Gradable opinion scale with gerund', ex:'"I really enjoy cooking at weekends."'},
    {name:'Comparatives (review)', desc:'Recycled from A0, extended to opinions', ex:'"My commute is longer than before."'},
  ],
  ...
  lessons:[
    ...
    { code:'A1-10', num:10, title:'Unit 1 Review — My life today',
      ...
      vocab:['ALL Unit 1 vocabulary + recycled A0'],
...
},
{
  ...
  lessons_count:10,
  grammar_summary:[
    {name:'Past Simple (extended)', desc:'Regular + irregular, career narrative, time expressions', ex:'"She left her job in 2019 and started her own company."'},
    {name:'Past Continuous', desc:'Actions in progress; contrast with past simple', ex:'"I was working when she called."'},
    {name:'Used to', desc:'Past habits and states no longer true', ex:'"I used to live in Paris but now I live in London."'},
    {name:'Present Perfect — experience', desc:'ever/never; life experiences', ex:'"Have you ever worked abroad?"'},
    {name:'Present Perfect — recent/duration', desc:'just, already, yet; for/since', ex:'"I\'ve just finished. She\'s worked here for five years."'},
    {name:'Reported Speech (intro)', desc:'say/tell + that; tense shift', ex:'"She said (that) she was tired."'},
  ],
  ...
  lessons:[
    ...
    { code:'A1-20', num:10, title:'Unit 2 Review — My past',
      ...
      vocab:['ALL Unit 2 vocabulary + recycled A0–U1'],
...
},
{
  ...
  lessons_count:10,
  grammar_summary:[
    {name:'Going to + will', desc:'Plans, intentions, predictions and spontaneous decisions', ex:'"I\'m going to change jobs. I think it will be difficult."'},
    {name:'Present continuous (future)', desc:'Fixed arrangements in diary', ex:'"I\'m meeting a client on Friday."'},
    {name:'First conditional', desc:'Real/possible future conditions', ex:'"If you work hard, you will succeed."'},
    {name:'Second conditional (intro)', desc:'Imagined/unlikely situations', ex:'"If I had more time, I would travel."'},
    {name:'Must / Need to / Have to', desc:'Necessity, obligation, prohibition', ex:'"You must arrive on time. You don\'t have to wear a tie."'},
    {name:'Could you / Would you mind', desc:'Polite requests and offers', ex:'"Could you send me the report? Would you mind helping?"'},
  ],
...
},
{
  ...
  lessons_count:10,
  grammar_summary:[
    {name:'Adjective + preposition', desc:'good at, bad at, interested in, worried about, etc.', ex:'"She is really good at dealing with clients."'},
    {name:'Defining relative clauses', desc:'who, which/that, where', ex:'"The person who manages the team is very experienced."'},
    {name:'Question tags', desc:'Positive → negative; negative → positive', ex:'"She\'s your boss, isn\'t she?"'},
    {name:'Indirect questions', desc:'Polite enquiry with statement word order', ex:'"Could you tell me where the meeting room is?"'},
    {name:'Opinion phrases', desc:'I think/believe/feel that + clause', ex:'"In my opinion, remote working is more productive."'},
  ],
