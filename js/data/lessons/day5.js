...
// --- DAY 5 | MONEY & SHOPPING ---

// English
if (!window.lessonsData["en"]) window.lessonsData["en"] = {};
window.lessonsData["en"]["5"] = {
    ...
    "words": [
        ...
        { "word": "I have to pay rent.", "emoji": "🏠", "clozeText": "I ______ to pay rent.", "answer": "have", "category": "grammar" }
    ]
};

// French
if (!window.lessonsData["fr"]) window.lessonsData["fr"] = {};
window.lessonsData["fr"]["5"] = {
    "title": "Jour 5 | Argent et achats",
    "words": [
...
// Italian
if (!window.lessonsData["it"]) window.lessonsData["it"] = {};
window.lessonsData["it"]["5"] = {
    "title": "Giorno 5 | Soldi e acquisti",
    "words": [
...
// Russian
if (!window.lessonsData["ru"]) window.lessonsData["ru"] = {};
window.lessonsData["ru"]["5"] = {
    "title": "День 5 | Деньги и покупки",
    "words": [
...
// Greek
if (!window.lessonsData["el"]) window.lessonsData["el"] = {};
window.lessonsData["el"]["5"] = {
    "title": "Ημέρα 5 | Χρήματα και αγορές",
    "words": [
