(function() {
    const data = [
    {
        ...
        "definitions": [
            {
                "text": "Le but de notre vie est d'être heureux.",
                "examples": []
            }
        ],
        "a": "Dalaï-lama",
        "o": "Chef spirituel tibétain",
        "c": "Vie et bonheur",
        "qs": [
    ...
    },
    {
        ...
        "a": "J.R.R. Tolkien",
        "o": "La Communauté de l'Anneau, 1954",
        "c": "Vie et bonheur",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "On ne vit qu'une fois, mais si on le fait bien, une fois suffit.",
                "examples": []
            }
        ],
        "a": "Mae West",
        "o": "Actrice et comédienne américaine",
        "c": "Vie et bonheur",
        "qs": [
    ...
    },
    {
        ...
        "a": "Oscar Wilde",
        "o": "Poète et dramaturge irlandais",
        "c": "Identité",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Il faut du courage pour grandir et devenir qui l'on est vraiment.",
                "examples": []
            }
        ],
        "a": "E.E. Cummings",
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Nous savons ce que nous sommes, mais nous ne savons pas ce que nous pourrions être.",
                "examples": []
            }
        ],
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "La forme la plus courante de désespoir est de ne pas être qui l'on est.",
                "examples": []
            }
        ],
        "a": "Søren Kierkegaard",
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Je n'ai pas échoué. J'ai juste trouvé 10 000 façons qui ne fonctionnent pas.",
                "examples": []
            }
        ],
        "a": "Thomas Edison",
        "o": "Inventeur américain",
        "c": "Échec et résilience",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Le succès consiste à aller d'échec en échec sans perte d'enthousiasme.",
                "examples": []
            }
        ],
        "a": "Winston Churchill",
        "o": "Premier ministre britannique",
        "c": "Échec et résilience",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Il est impossible de vivre sans échouer à quelque chose, à moins de vivre si prudemment que l'on n'aurait pas vécu du tout.",
                "examples": []
            }
        ],
        "a": "J.K. Rowling",
        "o": "Discours à Harvard, 2008",
        "c": "Échec et résilience",
        "qs": [
    ...
    },
    {
        ...
        "a": "Steve Jobs",
        "o": "Discours à Stanford, 2005",
        "c": "Travail et mission",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Deux choses sont infinies : l'univers et la bêtise humaine ; et je ne suis pas sûr de l'univers.",
                "examples": []
            }
        ],
        "a": "Albert Einstein",
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Nul homme n'est une île, un tout en soi.",
                "examples": []
            }
        ],
        "a": "John Donne",
        "o": "Méditation XVII, 1624",
        "c": "Nature humaine",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "L'obscurité ne peut pas chasser l'obscurité ; seule la lumière peut le faire. La haine ne peut pas chasser la haine ; seul l'amour peut le faire.",
                "examples": []
            }
        ],
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "L'art n'est pas ce que vous voyez, mais ce que vous faites voir aux autres.",
                "examples": []
            }
        ],
        "a": "Edgar Degas",
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Le monde semble toujours plus radieux quand on vient de fabriquer quelque chose qui n'existait pas auparavant.",
                "examples": []
            }
        ],
        "a": "Neil Gaiman",
        "o": "Auteur de Coraline, Good Omens",
        "c": "Créativité et art",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "La meilleure chose à laquelle se raccrocher dans la vie, c'est l'un à l'autre.",
                "examples": []
            }
        ],
        "a": "Audrey Hepburn",
        "o": "Actrice et humanitaire",
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Il faut danser comme s'il n'y avait personne pour regarder, aimer comme si on ne devait jamais être blessé.",
                "examples": []
            }
        ],
        "a": "William W. Purkey",
        "o": "Auteur et professeur",
        "c": "Amour et relations",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Nous acceptons l'amour que nous pensons mériter.",
                "examples": []
            }
        ],
        "a": "Stephen Chbosky",
        "o": "Le Monde de Charlie, 1999",
        "c": "Amour et relations",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Une injustice n'importe où est une menace pour la justice partout.",
                "examples": []
            }
        ],
        "a": "Martin Luther King Jr.",
        "o": "Lettre de la prison de Birmingham, 1963",
        "c": "Liberté et justice",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "La liberté ne vaut pas la peine d'être vécue si elle n'inclut pas la liberté de faire des erreurs.",
                "examples": []
            }
        ],
        "a": "Mahatma Gandhi",
        "o": "Chef de l'indépendance indienne",
        "c": "Liberté et justice",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "La vérité vous libérera, mais d'abord elle vous rendra misérable.",
                "examples": []
            }
        ],
        "a": "James A. Garfield",
        "o": "20e président des États-Unis, attribué",
        "c": "Liberté et justice",
        "qs": [
    ...
    },
    {
        ...
        "a": "Eleanor Roosevelt",
        "o": "Diplomate et activiste, attribué",
        "c": "Changement et temps",
        "qs": [
    ...
    {
        "id": "fr_upper_intermediate_time_002",
        "word": "La mesure de l'intelligence est la capacité de changer.",
        "lang": "fr",
        "level": "upper_intermediate",
        "theme": "time",
        "sub_theme": null,
        ...
        "definitions": [
            {
                "text": "La mesure de l'intelligence est la capacité de changer.",
                "examples": []
            }
        ],
        "a": "Albert Einstein",
        "o": "Physicien théoricien, attribué",
        "c": "Changement et temps",
        "qs": [
    ...
    },
    {
        ...
        "word": "On dit toujours que le temps change les choses, mais c'est à vous de les changer vous-même.",
        "lang": "fr",
        "level": "upper_intermediate",
        "theme": "time",
        "sub_theme": "months",
        ...
        "definitions": [
            {
                "text": "On dit toujours que le temps change les choses, mais c'est à vous de les changer vous-même.",
                "examples": []
            }
        ],
        "a": "Andy Warhol",
        "o": "Artiste pop américain",
        "c": "Changement et temps",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Pourquoi cet air si sérieux ?",
                "examples": []
            }
        ],
        "a": "Le Joker",
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Un grand pouvoir implique de grandes responsabilités.",
                "examples": []
            }
        ],
        "a": "Oncle Ben / Voltaire",
        "o": "Spider-Man / Attribué à Voltaire",
        "c": "Pop culture",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Après tout ce temps ? Toujours.",
                "examples": []
            }
        ],
        "a": "Severus Rogue",
        "o": "Harry Potter et les Reliques de la Mort, 2007",
        "c": "Pop culture",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Tu es gentille, tu es intelligente, tu es importante.",
                "examples": []
            }
        ],
        "a": "Aibileen Clark",
        "o": "La Couleur des sentiments, 2011",
        "c": "Pop culture",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Ce n'est pas ce que je suis en dessous, mais ce que je fais qui me définit.",
                "examples": []
            }
        ],
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Nage droit devant toi.",
                "examples": []
            }
        ],
        "a": "Dory",
        "o": "Le Monde de Nemo, 2003",
        "c": "Pop culture",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Je suis si intelligent que parfois je ne comprends pas un seul mot de ce que je dis.",
                "examples": []
            }
        ],
        "a": "Oscar Wilde",
        "o": "Le Prince Heureux et autres contes, 1888",
        "c": "Esprit et humour",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "J'ai passé une soirée parfaitement merveilleuse, mais ce n'était pas celle-ci.",
                "examples": []
            }
        ],
        "a": "Groucho Marx",
        "o": "Comédien américain",
        "c": "Esprit et humour",
        "qs": [
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Les femmes bien élevées marquent rarement l'histoire.",
                "examples": []
            }
        ],
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Je ne suis pas superstitieux, mais je suis un peu stitieux.",
                "examples": []
            }
        ],
        "a": "Michael Scott",
