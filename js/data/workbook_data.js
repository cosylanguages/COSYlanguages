...
const WORKBOOK_TOPICS = [
  {
    ...
    verbKey: 'to be', // Links to grammar.js data
    exercises: [
  ...
  },
  {
    ...
    verbKey: 'to work', // Using work as an example for present simple
    exercises: [
  ...
  {
    id: 'fr-er', lang: 'fr', flag: '🇫🇷', level: 'a1', title: 'Verbes en -ER',
    desc: 'parler · présent de l\'indicatif · 6 formes',
    ref: 'grammar-reference.html#lang-fr',
    verbKey: 'parler',
    exercises: [
      { type: 'mcq', q: 'Tu ___ français ? (parler)', opts: ['parle','parles','parlez'], answer: 'parles', fb: '✅ Tu → -es' },
      { type: 'fill', q: 'Nous ___ ensemble. (parler)', answer: 'parlons', fb: '✅ Nous → -ons' },
      { type: 'mcq', q: 'Ils ___ en classe. (parler)', opts: ['parle','parlent','parlons'], answer: 'parlent', fb: '✅ Ils/Elles → -ent (muet !)' },
      { type: 'fill', q: 'Vous ___ trop vite. (parler)', answer: 'parlez', fb: '✅ Vous → -ez' },
    ]
  },
  {
