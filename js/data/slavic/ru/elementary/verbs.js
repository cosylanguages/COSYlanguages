(function() {
    ...
    },
    {
        ...
        "tenses": {
            "present_simple": {
                "positive": ["поддерживаю", "поддерживаешь", "поддерживает", "поддерживает", "поддерживает", "поддерживаем", "поддерживаете", "поддерживают"],
                "negative": ["не поддерживаю", "не поддерживаешь", "не поддерживает", "не поддерживает", "не поддерживает", "не поддерживаем", "не поддерживаете", "не поддерживают"]
            }
        }
    },
    {
