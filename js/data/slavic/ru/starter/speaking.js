(function() {
    ...
    "ru": {
        ...
        "debates": [
            ...
            {
                "topic": "Жить с бабушкой и дедушкой или не жить с ними — что лучше?",
                "sideA": "С ними",
                "sideB": "Без них",
                "level": "starter",
                "theme": "immediate_family_A1",
                "ideasA": ["Помощь", "Узнать истории"],
                "ideasB": ["Больше места", "Тихий дом"]
            },
            {
                "topic": "Готовит мама или готовит папа — что лучше?",
                "sideA": "Мама",
                "sideB": "Папа",
                "level": "starter",
                "theme": "basic_foods_A1",
                "ideasA": ["Вкусная паста", "Много любви"],
                "ideasB": ["Лучшая пицца", "Новые рецепты"]
            },
            {
                "topic": "Математика или ИЗО — что лучше?",
                "sideA": "Математика",
                "sideB": "ИЗО",
                "level": "starter",
                "theme": "leisure_activities_A1",
                "ideasA": ["Числа", "Логика"],
                "ideasB": ["Цвета", "Рисование"]
            },
            {
                "topic": "Писать на бумаге или на планшете — что лучше?",
                "sideA": "Бумага",
                "sideB": "Планшет",
                "level": "starter",
                "theme": "basic_technology_devices_A1",
                "ideasA": ["Нет батарейки", "Приятно писать"],
                "ideasB": ["Быстро", "Бережем бумагу"]
            },
            {
                "topic": "День в парке или день на пляже — что лучше?",
                "sideA": "Парк",
                "sideB": "Пляж",
                "level": "starter",
                "theme": "address_location_A1",
                "ideasA": ["Зеленая трава", "Деревья"],
                "ideasB": ["Песок", "Синее море"]
            },
            {
                "topic": "Кошки, которые все роняют, или собаки, которые грызут обувь — что хуже?",
                "sideA": "Кошки",
                "sideB": "Собаки",
                "level": "starter",
                "theme": "animals_A1",
                "ideasA": ["Разбитое стекло", "Беспорядок"],
                "ideasB": ["Нет обуви", "Дорого"]
            },
            {
                ...
                "level": "starter",
                "theme": "basic_foods_A1",
                "ideasA": ["Чистые руки", "Элегантно"],
                "ideasB": ["Быстро", "Настоящий способ"]
            },
            {
                "topic": "Спать в носках или без носков — что лучше?",
                "sideA": "В носках",
                "sideB": "Без носков",
                "level": "starter",
                "theme": "furniture_objects_A1",
                "ideasA": ["Теплые ноги", "Уютно"],
                "ideasB": ["Свежесть", "Удобно"]
            },
            {
                "topic": "Работать полный день или неполный день — что лучше?",
                "sideA": "Полный день",
                "sideB": "Неполный день",
                "level": "starter",
                "theme": "workplace_basics_A1",
                "ideasA": ["Больше денег", "Большие проекты"],
                "ideasB": ["Больше свободного времени", "Меньше стресса"]
            },
            {
                "topic": "Любимая работа или работа с высокой зарплатой — что лучше?",
                "sideA": "Любовь",
                "sideB": "Деньги",
                "level": "starter",
                "theme": "workplace_basics_A1",
                "ideasA": ["Счастлив каждый день", "Нет стресса"],
                "ideasB": ["Купить большой дом", "Нет проблем с деньгами"]
            },
            {
                ...
                "level": "starter",
                "theme": "address_location_A1",
                "ideasA": ["Магазины", "Кинотеатры"],
                "ideasB": ["Дружелюбно", "Тихо"]
            },
            {
                "topic": "Иметь детей или не иметь детей — что лучше?",
                "sideA": "Дети",
                "sideB": "Без детей",
                "level": "starter",
                "theme": "immediate_family_A1",
                "ideasA": ["Семья в будущем", "Много веселья"],
                "ideasB": ["Свободное время", "Легко путешествовать"]
            },
            {
                ...
                "level": "starter",
                "theme": "leisure_activities_A1",
                "ideasA": ["Сильное тело", "Энергия"],
                "ideasB": ["Восстановление", "Расслабление"]
            },
            {
                ...
                "level": "starter",
                "theme": "furniture_objects_A1",
                "ideasA": ["Быстрая помощь", "Безопасно"],
                "ideasB": ["Экономия денег", "Естественно"]
            },
            {
                "topic": "Спать восемь часов или спать меньше — что лучше?",
                "sideA": "8 часов",
                "sideB": "Меньше",
                "level": "starter",
                "theme": "furniture_objects_A1",
                "ideasA": ["Отдохнувший", "Здоровый"],
                "ideasB": ["Закончить работу", "Больше веселья"]
            },
            {
                "topic": "Онлайн-шопинг или покупки в магазине — что лучше?",
                "sideA": "Онлайн",
                "sideB": "Магазин",
                "level": "starter",
                "theme": "shopping_basics_A1",
                "ideasA": ["Просто", "Быстро"],
                "ideasB": ["Видеть вещи", "Примерить одежду"]
            },
            {
                "topic": "Дорогие вещи или дешевые вещи — что лучше?",
                "sideA": "Дорогие",
                "sideB": "Дешевые",
                "level": "starter",
                "theme": "shopping_basics_A1",
                "ideasA": ["Хорошее качество", "Служат долго"],
                "ideasB": ["Экономия денег", "Много вещей"]
            },
            {
                "topic": "Покупать новое или покупать б/у — что лучше?",
                "sideA": "Новое",
                "sideB": "Б/у",
                "level": "starter",
                "theme": "shopping_basics_A1",
                "ideasA": ["Чистое", "Нет проблем"],
                "ideasB": ["Дешево", "Бережем природу"]
            },
            {
                ...
                "level": "starter",
                "theme": "address_location_A1",
                "ideasA": ["Безопасно", "Без затрат"],
                "ideasB": ["Захватывающе", "Вечеринка"]
            },
            {
                ...
                "level": "starter",
                "theme": "address_location_A1",
                "ideasA": ["Просто", "Без самолета"],
                "ideasB": ["Новая культура", "Приключение"]
            },
            {
                "topic": "Отвечать на имейлы сразу или оставлять на потом — что лучше?",
                "sideA": "Сразу",
                "sideB": "Потом",
                "level": "starter",
                "theme": "workplace_basics_A1",
                "ideasA": ["Профессионально", "Закончить быстро"],
                "ideasB": ["Хорошо подумать", "Без спешки"]
            },
            {
                "topic": "Мыть посуду сразу или оставлять до завтра — что лучше?",
                "sideA": "Сразу",
                "sideB": "До завтра",
                "level": "starter",
                "theme": "furniture_objects_A1",
                "ideasA": ["Чистая кухня", "Свежее утро"],
                "ideasB": ["Отдых сейчас", "Сделать все потом"]
            },
            {
                ...
                "level": "starter",
                "theme": "workplace_basics_A1",
                "ideasA": ["Долго ждать", "Скучно"],
                "ideasB": ["Невежливо", "Пропустить начало"]
            },
            {
                ...
                "level": "starter",
                "theme": "workplace_basics_A1",
                "ideasA": ["Находить вещи", "Концентрация"],
                "ideasB": ["Творчески", "Быстро"]
            },
            {
                "topic": "Говорить о работе за ужином или не говорить о ней — что лучше?",
                "sideA": "О работе",
                "sideB": "Без работы",
                "level": "starter",
                "theme": "basic_foods_A1",
                "ideasA": ["Решить проблемы", "Поделиться днем"],
                "ideasB": ["Отдых", "Время с семьей"]
            }
        ],
        "talkThatTalk": [
            {
