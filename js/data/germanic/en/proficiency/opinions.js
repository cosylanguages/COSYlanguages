(function() {
    const data = [
    {
        ...
        "h": [
            ...
            "What would it mean for your choices if identity is constructed rather than found?",
            "Is there anything that feels like a fixed, essential you?",
            "Does the self you present to others shape the self you become?",
    ...
    },
    {
        ...
        "h": [
            ...
            "Can you think of a case where a simplified story distorted a complex reality?",
            "Does sentimentality make us feel like we are doing something when we are not?",
            "Is simplification sometimes necessary to generate empathy?",
            "What is the cost of reducing suffering to a digestible narrative?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "time",
    ...
    },
    {
        ...
        "h": [
            "Can you think of an ideology that escapes this logic?",
            "Is this a reason to reject ideology altogether or to hold it lightly?",
            "What is the difference between a principled position and an ideology?",
            "Does pragmatism avoid this trap or just hide it?",
            "Does this mean all political positions are equally dangerous?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "environment",
    ...
    },
    {
        ...
        "tag": "Society",
        "h": [
            "Is contentment political?",
            "Does the economy require dissatisfied consumers?",
            "Is genuine contentment even possible or is it just a story we tell?",
            "Is there a difference between contentment and resignation?",
            "Does being content mean you have stopped caring about injustice?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "social",
    ...
    },
    {
        ...
        "h": [
            ...
            "Who decides which positions deserve a platform?",
            "Is there a difference between balance and false equivalence?",
            "Can journalistic neutrality coexist with epistemic standards?",
            "What is the cost of platforming a position purely in the name of fairness?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "social",
    ...
    },
    {
        ...
        "tag": "Ethics",
        "h": [
            "Is the impulse to 'tell it like it is' about the other person or about your own relief?",
            "Can you think of a moment when radical honesty did real harm?",
            "Is kindness sometimes the more courageous choice?",
            "Where is the line between honesty and cruelty?",
            "Does the demand for total honesty in relationships reflect intimacy or control?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "social",
    ...
    },
    {
        ...
        "tag": "Philosophy",
        "h": [
            "Does it matter whether free will is real if we have to act as though it is?",
    ...
    },
    {
        ...
        "h": [
            ...
            "Is the problem the internet itself or human nature interacting with it?",
            "What epistemic practices protect against this?",
            "Is expertise still meaningful in an age where everyone can publish?",
            "Do you trust your own ability to evaluate information online?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "technology",
    ...
    },
    {
        ...
        "h": [
            "Can you think of something widely accepted today that represents genuine moral progress?",
            "Can you think of something we have lost or regressed on?",
            "Is the belief in moral progress itself a culturally specific idea?",
            "Does moral fashion get mistaken for moral progress?",
            "What is your evidence that we are genuinely better than previous generations?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "psychology",
    ...
    },
    {
        ...
        "tag": "Philosophy",
        "h": [
            "Can you think of a historical or personal example where the need for certainty caused harm?",
            "Is doubt a moral virtue?",
            "Do people with unshakeable convictions make the world better or worse?",
            "Is there a form of certainty that is not dangerous?",
            "How do you hold strong beliefs without becoming rigid?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "technology",
    ...
    },
    {
        ...
        "h": [
            ...
            "Is the framing of climate change and exploitation as personal responsibility a deliberate political move?",
            "What is the difference between systemic change and individual action?",
            "Is it possible to live ethically within an unethical system?",
            "Does acknowledging the impossibility of ethical consumption change how you behave?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "psychology",
    ...
    },
    {
        ...
        "h": [
            ...
            "Can introspection become a form of avoidance?",
            "Is there a cost to examining your own life continuously?",
            "Are there people who live deeply and well without much self-examination?",
            "What do you think your own level of self-reflection has cost and given you?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "social",
    ...
    },
    {
        ...
        "tag": "Ethics & Space",
        "h": [
            "Do we have a right to claim other worlds if we haven't solved problems on our own?",
            "Should we export human systems (capitalism, nationalism) to space?",
            "What are our moral obligations to potential extraterrestrial life, however microbial?",
            "Is 'Plan B' thinking a dangerous distraction from ecological preservation on Earth?",
            "Who should own or govern planetary resources?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "social",
    ...
    },
    {
        ...
        "tag": "Philosophy",
        "h": [
            "If our actions are determined by prior causes, can we be held responsible?",
            "Is the feeling of choice enough to prove free will?",
            "Could a sufficiently advanced computer predict all your future decisions?",
            "What is the difference between 'freedom from' and 'freedom to'?",
            "Does the existence of a soul or consciousness change the equation?"
        ],
        "lang": "en",
        "level": "proficiency",
        "theme": "psychology",
