(function() {
        ...
        "definitions": [
            {
                ...
                "examples": [
                    "Πρέπει να μειώσουμε τα απορρίμματα (απόβλητα) τροφίμων."
                ]
            }
        ]
    },
    ...
    },
    {
        ...
        "definitions": [
            {
                "text": "Μια σειρά οδηγιών για την επίλυση ενός προβλήματος.",
                "examples": [
                    "Τα κοινωνικά δίκτυα χρησιμοποιούν αλγόριθμους."
                ]
            }
        ]
    }
