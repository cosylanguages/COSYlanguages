(function() {
    ...
    },
    {
        ...
        "tenses": {
            "present_simple": {
                "positive": ["υποστηρίζω", "υποστηρίζεις", "υποστηρίζει", "υποστηρίζει", "υποστηρίζει", "υποστηρίζουμε", "υποστηρίζετε", "υποστηρίζουν"],
                "negative": ["δεν υποστηρίζω", "δεν υποστηρίζεις", "δεν υποστηρίζει", "δεν υποστηρίζει", "δεν υποστηρίζει", "δεν υποστηρίζουμε", "δεν υποστηρίζετε", "δεν υποστηρίζουν"]
            }
        }
    },
    {
