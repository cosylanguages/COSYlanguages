...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        window.hotSeatStart = function() {
          ...
          let tCount = HotSeatGame.DURATION;
          ...
          HotSeatGame._interval = setInterval(() => {
            ...
            if (tCount <= 0) { clearInterval(HotSeatGame._interval); document.getElementById('hot-seat-area').innerHTML = HotSeatGame.buildSummary(); }
            if (tCount <= 10) el.style.color = '#a32d2d';
          }, 1000);
        };
        ...
        window.hotSeatSubmit = function() {
          ...
          if (!input || !q) return;
          window.hotSeatAnswer(q.accept && q.accept.includes(input.value.trim().toLowerCase()));
        };
