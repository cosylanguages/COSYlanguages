(function() {
    const data = [
    {
        "t": "Ein Urlaub, an den du dich erinnerst",
        "h": [
    ...
    {
        "t": "Dein Lieblingsrestaurant oder -café",
        "h": [
            "Wo ist es?",
    ...
    {
        "t": "Was du tust, um dich zu entspannen",
        "h": [
    ...
    {
        "t": "Ein Film, den du vor Kurzem gesehen hast",
        "h": [
            "Wie hieß der Film?",
            "Wovon handelte er?",
            "Hat er dir gefallen?",
    ...
    {
        "t": "Eine Person, die du bewunderst",
        "h": [
    ...
    {
        "t": "Deine Beziehung zu deinem Handy",
        "h": [
    ...
    {
        "t": "Etwas Lustiges, das dir passiert ist",
        "h": [
    ...
    {
        "t": "Ein Geburtstag, an den du dich erinnerst",
        "h": [
    ...
    {
        "t": "Dinge, die du an deinem Wohnort liebst",
        "h": [
    ...
    {
        "t": "Etwas, das du vor Kurzem gekauft hast",
        "h": [
            "Was hast du gekauft?",
    ...
    {
        "t": "Was du gestern gegessen hast",
        "h": [
