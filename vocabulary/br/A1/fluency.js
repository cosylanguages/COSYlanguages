(function() {
    const data = [
        ...
        { t: "Chifroù en ho puhez", h: ["Pet bloaz oc'h ?","Peini eo ho chifr a chans ?","Pet den a zo o chom en ho ti ?","Da bet eur e tivunoc'h ?","Pet yezh a gomzit ?"], level: "starter", theme: "numbers_0_9_A1" },
        ...
        { t: "Ho pro", h: ["Peini eo ho pro ?","Peini eo ar gêr-benn ?","Penaos eo an amzer ?","Peseurt boued a zo brudet eno ?","Petra a garit en ho pro ?"], level: "starter", theme: "countries_capitals_A1" },
        { t: "Traoù en ho kambr-dour", h: ["Peseurt arrebeuri a zo en ho kambr ?","Peseurt liv eo ho kambr ?","Hag ur gambr vras pe vihan eo ?","Petra a zo war ho taol ?","Ha plijout a ra ho kambr deoc'h ?"], level: "starter", theme: "furniture_objects_A1" },
        ...
        { t: "Traoù a welit dre ho prenestr", h: ["Petra a zo er-maez d'ho prenestr ?","Ha gwelet a rit gwez pe savadurioù ?","Petra a glevit ?","Hag ur gwel sioul pe gant kalz traoù eo ?","Ha plijout a ra ar gwel-mañ deoc'h ?"], level: "starter", theme: "furniture_objects_A1" },
